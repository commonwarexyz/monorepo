...
::: {.image-caption}
Figure 1: Each square represents one 5ms target interval. A 20 by 10 grid fills in one second. Alto sustained 198.1 successful views per nominal second against this 200-view target.
:::
