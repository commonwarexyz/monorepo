...
We summarize them below and, as we will see, every construction makes an all-or-nothing compromise on some dimension -- censorship resistance, epoch restrictions, or complicated setups.
We then present two new constructions that interpolate the Pareto frontier, allowing system designers to pick a trade-off point that best fits their operating constraints.
