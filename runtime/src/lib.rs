...
stability_scope!(BETA {
    ...
    pub mod iobuf;
    pub use iobuf::{
        cache_line_size, page_size, BufferPool, BufferPoolClassConfig, BufferPoolConfig,
        BufferPoolThreadCache, Builder as IoBufsBuilder, IoBuf, IoBufMut, IoBufs, IoBufsMut,
    };
