...
///     let mut blob = Write::from_pooler(context.with_label("writer"), blob, 0, NZUsize!(16));
...
///     let mut reader = Read::from_pooler(context.with_label("reader"), blob, size, NZUsize!(8));
