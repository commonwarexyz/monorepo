...
mod tests {
    ...
    use crate::{
        ...
        BufferPool, BufferPoolConfig, BufferPooler, IoBufsMut, Runner as _, Storage as _,
    };
    ...
    fn test_read_many_into_empty() {
        ...
        executor.start(|context: deterministic::Context| async move {
            ...
            let cache_ref = context
                .storage_buffer_pool()
                .page_cache(PAGE_SIZE, NZUsize!(BUFFER_SIZE));
    ...
    fn test_read_many_into_straddle_prefix_miss() {
        ...
        executor.start(|context: deterministic::Context| async move {
            ...
            let cache_ref = context
                .storage_buffer_pool()
                .page_cache(PAGE_SIZE, NZUsize!(1));
            let append = Append::new(blob, blob_size, BUFFER_SIZE, cache_ref)
                .await
                .unwrap();
    ...
    fn test_sync_releases_tip_pool_slot_after_full_drain() {
        ...
        executor.start(|context: deterministic::Context| async move {
            ...
            let cache_ref = pool.page_cache(PAGE_SIZE, NZUsize!(1));
    ...
    fn test_resize_same_page_shrink_survives_interrupted_len_stage() {
        ...
        executor.start(|context| async move {
            ...
            let cache_ref = context
                .storage_buffer_pool()
                .page_cache(LARGE_PAGE_SIZE, NZUsize!(LARGE_BUFFER_SIZE));
    ...
    fn test_reopen_partial_tail_append_and_resize() {
        ...
        executor.start(|context| async move {
            ...
            let cache_ref = context
                .storage_buffer_pool()
                .page_cache(PAGE_SIZE, NZUsize!(4));
