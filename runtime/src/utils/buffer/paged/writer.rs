...
//! # Recovery
//!
//! [Recovery::open] trims an invalid tail before the retained prefix is published, and
//! [Recovery::truncate] makes its selected prefix durable before returning. Conversion into a
//! [Writer] preserves that state without another flush or sync. [Writer::resize] is a live mutation
//! whose durability follows the ordinary writer sync contract.
//!
//! # Raw [Blob] handles
//!
