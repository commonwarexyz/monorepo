...
mod tests {
    ...
    fn test_cache_read_with_blob() {
        ...
        executor.start(|context| async move {
            ...
            let cache_ref = CacheRef::from_pooler(context.clone(), PAGE_SIZE, NZUsize!(10));
    ...
    fn test_cache_max_page() {
        let executor = deterministic::Runner::default();
        executor.start(|context| async move {
            let cache_ref = CacheRef::from_pooler(context.clone(), PAGE_SIZE, NZUsize!(2));
    ...
    fn test_cache_at_high_offset() {
        ...
        executor.start(|context| async move {
            ...
            let cache_ref =
                CacheRef::from_pooler(context.clone(), NZU16!(MIN_PAGE_SIZE as u16), NZUsize!(2));
