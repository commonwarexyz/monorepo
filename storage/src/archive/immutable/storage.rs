...
impl<E: Storage + Metrics + Clock, K: Array, V: Codec> Archive<E, K, V> {
    ...
    pub async fn init(context: E, cfg: Config<V::Cfg>) -> Result<Self, Error> {
        ...
        let freezer = Freezer::init_with_checkpoint(
            ...
            freezer::Config {
                codex_partition: cfg.freezer_journal_partition,
                codex_compression: cfg.freezer_journal_compression,
                codex_write_buffer: cfg.write_buffer,
                codex_target_size: cfg.freezer_journal_target_size,
                codex_buffer_pool: cfg.freezer_journal_buffer_pool,
