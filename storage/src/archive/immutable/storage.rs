...
use commonware_runtime::{Spawner, Clock, Metrics, Storage};
...
pub struct Archive<E: Storage + Metrics + Clock + Spawner, K: Array, V: CodecShared> {
...
impl<E: Storage + Metrics + Clock + Spawner, K: Array, V: CodecShared> Archive<E, K, V> {
...
impl<E: Storage + Metrics + Clock + Spawner, K: Array, V: CodecShared> crate::archive::Archive
    for Archive<E, K, V>
{
    type Key = K;
    type Value = V;
