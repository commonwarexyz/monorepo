//! A mutable key-value database that associates variable-sized values with keys from an unordered
//! key space.
//!
//! # Terminology
//!
...
//!     log_db::{store::{Store, Config}, KeyValueStore as _},
//!     translator::TwoCap,
//! };
...
impl<E, K, V, T> KeyValueStore<E, K, V, T> for Store<E, K, V, T>
where
    E: RStorage + Clock + Metrics,
    K: Array,
    V: Codec,
