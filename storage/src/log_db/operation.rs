...
//!
//! The `Operation` enum implements the [Codec] trait, allowing for a persistent log of operations
//! based on a `crate::Journal`. The `FixedOperation` enum additionally implements [CodecFixed].
