...
//! implementations are based on a [crate::log_db::adb::any::fixed] authenticated database combined
...
pub fn verify_range_proof<H: CHasher, O: OperationTrait, const N: usize>(
