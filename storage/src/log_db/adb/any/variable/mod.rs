...
//!
//! _If the values you wish to store all have the same size, use the dbs in
//! [crate::log_db::adb::any::fixed] instead for better performance._
...
use crate::{
    ...
    log_db::{
        ...
        operation::Variable as Operation,
    },
    mmr::{
