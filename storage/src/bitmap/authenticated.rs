...
/// whose root digest has been computed. DirtyBitMap represents a bitmap with pending updates.
/// A dirty bitmap can be converted into a clean bitmap by calling DirtyBitMap::merkleize.
///
/// # Warning
///
...
mod tests {
    ...
    fn test_bitmap_building() {
        ...
        executor.start(|_| async move {
            ...
            let mut bitmap = CleanBitMap::<_, SHA256_SIZE>::new(&mut hasher, None);
    ...
    fn test_bitmap_persistence() {
        ...
        executor.start(|context| async move {
            ...
            let mut bitmap = CleanBitMap::<_, SHA256_SIZE>::restore_pruned(
                context.clone(),
                PARTITION,
                None,
                &mut hasher,
