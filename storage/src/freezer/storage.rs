...
use commonware_runtime::{Spawner, buffer, Blob, Clock, Metrics, Storage};
...
pub struct Freezer<E: Storage + Metrics + Clock + Spawner, K: Array, V: CodecShared> {
...
impl<E: Storage + Metrics + Clock + Spawner, K: Array, V: CodecShared> Freezer<E, K, V> {
...
impl<E: Storage + Metrics + Clock + Spawner, K: Array, V: CodecShared> kv::Gettable for Freezer<E, K, V> {
    type Key = K;
    type Value = V;
    type Error = Error;
...
impl<E: Storage + Metrics + Clock + Spawner, K: Array, V: CodecShared> kv::Updatable for Freezer<E, K, V> {
...
impl<E: Storage + Metrics + Clock + Spawner, K: Array, V: CodecShared> Persistable for Freezer<E, K, V> {
    type Error = Error;
