...
//! that maps keys to locations and a [crate::journal::segmented::Journal] that stores key-value data.
//!
//! ```text
//! +-----------------------------------------------------------------+
//! |                           Hash Table                            |
...
pub struct Config<C> {
    ...
    /// The compression level to use for the [crate::journal::segmented::Journal].
