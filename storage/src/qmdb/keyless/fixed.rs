...
mod tests {
    ...
    keyless_tests! {
        test_keyless_fixed_empty => run_empty, "INFO", reopen_indexed;
        test_keyless_fixed_build_basic => run_build_basic, "WARN", reopen_indexed;
        test_keyless_fixed_recovery => run_recovery, "WARN", reopen_indexed;
        test_keyless_fixed_non_empty_recovery => run_non_empty_recovery, "WARN", reopen_indexed;
        test_keyless_fixed_proof => run_proof, "INFO", db;
        test_keyless_fixed_proof_comprehensive => run_proof_comprehensive, "INFO", db;
        test_keyless_fixed_proof_with_pruning => run_proof_with_pruning, "INFO", reopen_indexed;
        test_keyless_fixed_empty_db_recovery => run_empty_db_recovery, "WARN", reopen_indexed;
        test_keyless_fixed_replay_with_trailing_appends => run_replay_with_trailing_appends, "WARN", reopen_indexed;
        test_keyless_fixed_get_out_of_bounds => run_get_out_of_bounds, "INFO", db;
        test_keyless_fixed_metadata => run_metadata, "INFO", db;
        test_keyless_fixed_pruning => run_pruning, "INFO", reopen;
        test_keyless_fixed_batch_get => run_batch_get, "INFO", db;
        test_keyless_fixed_batch_stacked_get => run_batch_stacked_get, "INFO", db;
        test_keyless_fixed_batch_speculative_root => run_batch_speculative_root, "INFO", db;
        test_keyless_fixed_merkleized_batch_get => run_merkleized_batch_get, "INFO", db;
        test_keyless_fixed_batch_chained => run_batch_chained, "INFO", db;
        test_keyless_fixed_batch_chained_apply_sequential => run_batch_chained_apply_sequential, "INFO", db;
        test_keyless_fixed_batch_many_sequential => run_batch_many_sequential, "INFO", db;
        test_keyless_fixed_batch_empty => run_batch_empty, "INFO", db;
        test_keyless_fixed_batch_chained_merkleized_get => run_batch_chained_merkleized_get, "INFO", db;
        test_keyless_fixed_batch_large => run_batch_large, "INFO", db;
        test_keyless_fixed_stale_batch => run_stale_batch, "DEBUG", reopen;
        test_keyless_fixed_stale_batch_chained => run_stale_batch_chained, "DEBUG", db;
        test_keyless_fixed_sequential_commit_parent_then_child => run_sequential_commit_parent_then_child, "DEBUG", db;
        test_keyless_fixed_stale_batch_child_before_parent => run_stale_batch_child_before_parent, "DEBUG", db;
        test_keyless_fixed_to_batch => run_to_batch, "DEBUG", db;
        test_keyless_fixed_child_root_matches_pending_and_committed => run_child_root_matches_pending_and_committed, "DEBUG", db;
        test_keyless_fixed_rewind_recovery => run_rewind_recovery, "INFO", reopen;
        test_keyless_fixed_rewind_pruned_target_errors => run_rewind_pruned_target_errors, "INFO", reopen;
        test_keyless_fixed_floor_tracking => run_floor_tracking, "INFO", reopen_indexed;
        test_keyless_fixed_floor_regression_rejected => run_floor_regression_rejected, "INFO", reopen;
        test_keyless_fixed_floor_beyond_commit_loc_rejected => run_floor_beyond_commit_loc_rejected, "INFO", reopen;
        test_keyless_fixed_rewind_restores_floor => run_rewind_restores_floor, "INFO", db;
        test_keyless_fixed_floor_at_commit_loc_accepted => run_floor_at_commit_loc_accepted, "INFO", db;
        test_keyless_fixed_rewind_after_reopen_with_floor => run_rewind_after_reopen_with_floor, "INFO", reopen_indexed;
        test_keyless_fixed_ancestor_floor_regression_rejected => run_ancestor_floor_regression_rejected, "INFO", reopen;
        test_keyless_fixed_ancestor_floor_beyond_commit_loc_rejected => run_ancestor_floor_beyond_commit_loc_rejected, "INFO", db;
        test_keyless_fixed_chained_apply_with_valid_floors_succeeds => run_chained_apply_with_valid_floors_succeeds, "INFO", db;
        test_keyless_fixed_single_commit_live_set => run_single_commit_live_set, "INFO", reopen_indexed;
