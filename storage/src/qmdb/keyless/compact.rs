    ...
    Operation<F, V>: EncodeShared,
{
    ...
    #[tracing::instrument(name = "qmdb.keyless.compact.merkleize", level = "info", skip_all)]
    ...
    C: Clone + Send + Sync + 'static,
{
    ...
    ///   location.
    #[tracing::instrument(name = "qmdb.keyless.compact.apply_batch", level = "info", skip_all)]
    pub fn apply_batch(
        &mut self,
    ...
    #[tracing::instrument(name = "qmdb.keyless.compact.sync", level = "info", skip_all)]
    ...
    #[tracing::instrument(name = "qmdb.keyless.compact.commit", level = "info", skip_all)]
    ...
    #[tracing::instrument(name = "qmdb.keyless.compact.rewind", level = "info", skip_all)]
