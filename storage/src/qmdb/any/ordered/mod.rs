    ...
    Operation<K, V>: Codec,
{
    ...
    ) -> Result<Option<LocatedKey<K, V::Value>>, Error> {
        #[allow(clippy::type_complexity)]
        let mut last_key: Option<LocatedKey<K, V::Value>> = None;
        for &loc in iter {
    ...
    /// empty.
    pub async fn get_span(&self, key: &K) -> Result<Option<LocatedKey<K, V::Value>>, Error> {
        if self.is_empty() {
            return Ok(None);
        }
    ...
    Operation<K, V>: Codec,
{
    ...
    async fn update_loc(
        ...
        #[allow(clippy::type_complexity)]
        let mut best_prev_key: Option<LocatedKey<K, V::Value>> = None;
        {
