...
pub type Update<V> = unordered::Update<Vec<u8>, VarKeyEncoding<V>>;
pub type Operation<V> = unordered::Operation<Vec<u8>, VarKeyEncoding<V>>;

/// A key-value QMDB based on an authenticated log of operations, supporting authentication of any
/// value ever associated with a variable-length key.
pub type Db<E, V, H, T, S = Merkleized<H>, D = Durable> = super::Db<
    E,
...
impl<E: Storage + Clock + Metrics, V: VariableValue, H: Hasher, T: Translator>
    Db<E, V, H, T, Merkleized<H>, Durable>
where
    Operation<V>: Read,
{
    ...
    pub async fn init(
        context: E,
        cfg: crate::qmdb::any::VariableConfig<T, <Operation<V> as Read>::Cfg>,
    ) -> Result<Self, Error> {
...
mod test {
    ...
    type VarKeyDb = Db<deterministic::Context, Vec<u8>, Sha256, TwoCap>;
