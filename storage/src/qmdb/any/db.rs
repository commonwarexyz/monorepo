...
/// Index mutation needed to undo one operation while rewinding.
enum IndexUndo<F: Family, K> {
    Replace {
        key: K,
        old_loc: Location<F>,
        new_loc: Location<F>,
