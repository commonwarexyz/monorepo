...
impl<F: Family, S: Update> crate::qmdb::operation::Operation for Operation<F, S> {
    type Family = F;
    type Key = S::Key;
...
mod tests {
    ...
    mod conformance {
        ...
        commonware_conformance::conformance_tests! {
            CodecConformance<OrderedOperation<MmrFamily, U64, FixedEncoding<U64>>>,
            CodecConformance<OrderedOperation<MmrFamily, U64, VariableEncoding<Vec<u8>>>>,
            CodecConformance<UnorderedOperation<MmrFamily, U64, FixedEncoding<U64>>>,
            CodecConformance<UnorderedOperation<MmrFamily, U64, VariableEncoding<Vec<u8>>>>,
        }
    }
}
