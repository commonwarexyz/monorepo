...
/// the node fetches, and the pages they hold, in flight at once. At 2^18 a batch pins at most
/// ~1GiB of pages yet is large enough to keep the storage queue full, and a database with tens of
/// millions of graftable chunks needs only about a hundred sequential batches.
