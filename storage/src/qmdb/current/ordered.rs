...
use crate::{
    ...
    qmdb::{
        any::{
            ordered::{fixed::Any, FixedOperation as Operation, OrderedUpdate},
...
pub enum ExclusionProof<K: Array, V: FixedValue, D: Digest, const N: usize> {
    ...
    /// is excluded.
    KeyValue(OperationProof<D, N>, OrderedUpdate<K, FixedEncoding<V>>),
    ...
    > Current<E, K, V, H, T, N, S>
{
    ...
    pub fn verify_key_value_proof(
        ...
        let op = Operation::Update(OrderedUpdate {
            key,
            value,
