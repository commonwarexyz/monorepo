...
pub mod test {
    use super::*;
    use crate::{
        qmdb::{current::tests::fixed_config, Error},
        translator::OneCap,
    };
    ...
    pub fn test_current_db_verify_proof_over_bits_in_uncommitted_chunk() {
        super::super::tests::test_verify_proof_over_bits_in_uncommitted_chunk(open_db);
    }

    #[test_traced("DEBUG")]
    pub fn test_current_db_range_proofs() {
        super::super::tests::test_range_proofs(open_db);
    }
    ...
    pub fn test_current_db_key_value_proof() {
        super::super::tests::test_key_value_proof(open_db);
    }

    #[test_traced("WARN")]
    pub fn test_current_db_proving_repeated_updates() {
        super::super::tests::test_proving_repeated_updates(open_db);
    }

    #[test_traced("DEBUG")]
    pub fn test_current_db_exclusion_proofs() {
        super::super::tests::test_exclusion_proofs(open_db);
    }
}
