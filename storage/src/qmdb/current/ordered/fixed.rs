...
pub mod test {
    ...
    pub fn test_range_proof_returns_error_on_pruned_chunks() {
        ...
        executor.start(|context| async move {
            ...
            let result = db
                .range_proof(&mut crypto_hasher, Location::new(0), NZU64!(1))
                .await;
            assert!(
    ...
    pub fn test_current_db_exclusion_proofs() {
        ...
        executor.start(|context| async move {
            ...
            let empty_proof = db
                .exclusion_proof(&mut crypto_hasher, &key_exists_1)
                .await
                .unwrap();
            ...
            let result = db.exclusion_proof(&mut crypto_hasher, &key_exists_1).await;
            ...
            let proof = db
                .exclusion_proof(&mut crypto_hasher, &greater_key)
                .await
                .unwrap();
            let proof2 = db
                .exclusion_proof(&mut crypto_hasher, &lesser_key)
                .await
                .unwrap();
            ...
            let proof = db
                .exclusion_proof(&mut crypto_hasher, &middle_key)
                .await
                .unwrap();
