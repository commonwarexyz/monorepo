//! A partitioned variant of [crate::qmdb::current::ordered::fixed] that uses a partitioned index for the snapshot.
//!
...
use crate::{
    ...
    qmdb::{
        any::{
            ordered::partitioned::fixed::{Db as AnyDb, Operation},
            value::FixedEncoding,
            FixedValue,
        },
        current::{
...
/// A partitioned variant of [crate::qmdb::current::ordered::fixed::Db].
///
...
pub type Db<E, K, V, H, T, const P: usize, const N: usize, S = Merkleized<H>, D = Durable> =
    crate::qmdb::current::ordered::db::Db<E, Journal<E, Operation<K, V>>, K, FixedEncoding<V>, Index<T, Location, P>, H, N, S, D>;
...
mod test {
    ...
    type CleanCurrentTestP1 =
        Db<deterministic::Context, Digest, Digest, Sha256, TwoCap, 1, 32, Merkleized<Sha256>, Durable>;
