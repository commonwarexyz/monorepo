//! A partitioned variant of [crate::qmdb::current::unordered::fixed] that uses a partitioned index for the snapshot.
//!
...
use crate::{
    ...
    qmdb::{
        any::{
            unordered::partitioned::fixed::{Db as AnyDb, Operation},
            value::FixedEncoding,
            FixedValue,
        },
        current::{
...
/// A partitioned variant of [crate::qmdb::current::unordered::fixed::Db].
///
...
pub type Db<E, K, V, H, T, const P: usize, const N: usize, S = Merkleized<H>, D = Durable> =
    crate::qmdb::current::unordered::db::Db<E, Journal<E, Operation<K, V>>, K, FixedEncoding<V>, Index<T, Location, P>, H, N, S, D>;
