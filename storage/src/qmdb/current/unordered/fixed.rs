...
pub mod test {
    ...
    pub fn test_current_db_verify_proof_over_bits_in_uncommitted_chunk() {
        ...
        executor.start(|context| async move {
            ...
            let proof = db.key_value_proof(&mut crypto_hasher, k).await.unwrap();
            ...
            let (range_proof, _, chunks) = db
                .range_proof(&mut crypto_hasher, op_loc, NZU64!(1))
                .await
                .unwrap();
        ...
        executor.start(|mut context| async move {
            ...
            for loc in *start_loc..*end_loc {
                ...
                let (proof, ops, chunks) = db
                    .range_proof(&mut crypto_hasher, loc, NZU64!(max_ops))
                    .await
                    .unwrap();
                assert!(
    ...
    pub fn test_current_db_key_value_proof() {
        ...
        executor.start(|mut context| async move {
            ...
            let res = db.key_value_proof(&mut crypto_hasher, bad_key).await;
            ...
            for i in start..db.status.len() {
                ...
                let proof = db.key_value_proof(&mut crypto_hasher, key).await.unwrap();
    ...
    pub fn test_current_db_proving_repeated_updates() {
        ...
        executor.start(|context| async move {
            ...
            for i in 1u8..=255 {
                ...
                let proof = db.key_value_proof(&mut crypto_hasher, k).await.unwrap();
                assert!(
                    CurrentTest::verify_key_value_proof(&mut crypto_hasher, k, v, &proof, &root),
