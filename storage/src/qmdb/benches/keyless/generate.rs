...
fn keyless_cfg() -> KConfig<(commonware_codec::RangeCfg<usize>, ())> {
...
type KeylessDb = Keyless<Context, Vec<u8>, Sha256, Merkleized<Sha256>, Durable>;
