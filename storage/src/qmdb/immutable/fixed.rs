...
mod tests {
    ...
    immutable_tests! {
        test_fixed_empty => run_empty, "WARN", open;
        test_fixed_build_basic => run_build_basic, "DEBUG", open;
        test_fixed_proof_verify => run_proof_verify, "WARN", open;
        test_fixed_prune => run_prune, "DEBUG", open;
        test_fixed_batch_chain => run_batch_chain, "DEBUG", open;
        test_fixed_build_and_authenticate => run_build_and_authenticate, "WARN", open;
        test_fixed_recovery_from_failed_merkle_sync => run_recovery_from_failed_merkle_sync, "WARN", open;
        test_fixed_recovery_from_failed_log_sync => run_recovery_from_failed_log_sync, "WARN", open;
        test_fixed_pruning => run_pruning, "WARN", open;
        test_fixed_prune_beyond_floor => run_prune_beyond_floor, "INFO", open;
        test_fixed_batch_get_read_through => run_batch_get_read_through, "INFO", open;
        test_fixed_batch_stacked_get => run_batch_stacked_get, "INFO", open;
        test_fixed_batch_stacked_apply => run_batch_stacked_apply, "INFO", open;
        test_fixed_batch_speculative_root => run_batch_speculative_root, "INFO", open;
        test_fixed_merkleized_batch_get => run_merkleized_batch_get, "INFO", open;
        test_fixed_batch_sequential_apply => run_batch_sequential_apply, "INFO", open;
        test_fixed_batch_many_sequential => run_batch_many_sequential, "INFO", open;
        test_fixed_batch_empty_batch => run_batch_empty_batch, "INFO", open;
        test_fixed_batch_chained_merkleized_get => run_batch_chained_merkleized_get, "INFO", open;
        test_fixed_batch_large => run_batch_large, "INFO", open;
        test_fixed_batch_chained_key_override => run_batch_chained_key_override, "INFO", open;
        test_fixed_batch_sequential_key_override => run_batch_sequential_key_override, "INFO", open_small_sections;
        test_fixed_batch_metadata => run_batch_metadata, "INFO", open;
        test_fixed_stale_batch_rejected => run_stale_batch_rejected, "DEBUG", open;
        test_fixed_stale_batch_chained => run_stale_batch_chained, "DEBUG", open;
        test_fixed_sequential_commit_parent_then_child => run_sequential_commit_parent_then_child, "DEBUG", open;
        test_fixed_stale_batch_child_applied_before_parent => run_stale_batch_child_applied_before_parent, "DEBUG", open;
        test_fixed_child_root_matches_pending_and_committed => run_child_root_matches_pending_and_committed, "DEBUG", open;
        test_fixed_to_batch => run_to_batch, "DEBUG", open;
        test_fixed_rewind_recovery => run_rewind_recovery, "INFO", open;
        test_fixed_rewind_pruned_target_errors => run_rewind_pruned_target_errors, "INFO", open_small_sections;
        test_fixed_inactivity_floor_tracking => run_inactivity_floor_tracking, "INFO", open;
        test_fixed_floor_monotonicity => run_floor_monotonicity, "INFO", open;
        test_fixed_floor_monotonicity_violation => run_floor_monotonicity_violation, "INFO", open;
        test_fixed_floor_beyond_size => run_floor_beyond_size, "INFO", open;
        test_fixed_chained_ancestor_floor_regression => run_chained_ancestor_floor_regression, "INFO", open;
        test_fixed_chained_ancestor_floor_beyond_size => run_chained_ancestor_floor_beyond_size, "INFO", open;
        test_fixed_rewind_restores_floor => run_rewind_restores_floor, "INFO", open;
        test_fixed_single_commit_live_set => run_single_commit_live_set, "INFO", open;
        test_fixed_rewind_after_reopen_with_floor_change => run_rewind_after_reopen_with_floor_change, "INFO", open;
        test_fixed_rewind_after_reopen_partial_floor_gap => run_rewind_after_reopen_partial_floor_gap, "INFO", open;
        test_fixed_commit_after_sync_recovery => run_commit_after_sync_recovery, "WARN", open;
        test_fixed_prune_after_uncommitted_apply_batch_recovery => run_prune_after_uncommitted_apply_batch_recovery, "WARN", open;
        test_fixed_rewind_preserves_collision_bucket => run_rewind_preserves_collision_bucket, "INFO", open;
        test_fixed_get_many => run_get_many, "INFO", open;
        test_fixed_get_many_unexpected_data => run_get_many_unexpected_data, "INFO", open;
        test_fixed_rewind_after_reopen_repeated_key_gap => run_rewind_after_reopen_repeated_key_gap, "INFO", open;
        test_fixed_rewind_after_reopen_mixed_gap_retained => run_rewind_after_reopen_mixed_gap_retained, "INFO", open;
    }
