...
mod tests {
    ...
    #[test_traced("INFO")]
    fn test_fixed_ancestor_floor_regression_rejected() {
        let executor = deterministic::Runner::default();
        executor.start(|ctx| async move {
    ...
    #[test_traced("INFO")]
    fn test_fixed_ancestor_floor_beyond_commit_loc_rejected() {
        let executor = deterministic::Runner::default();
        executor.start(|ctx| async move {
    ...
    #[test_traced("INFO")]
    fn test_fixed_ancestor_floor_regression_rejected_mmb() {
        let executor = deterministic::Runner::default();
        executor.start(|ctx| async move {
    ...
    #[test_traced("INFO")]
    fn test_fixed_ancestor_floor_beyond_commit_loc_rejected_mmb() {
        let executor = deterministic::Runner::default();
        executor.start(|ctx| async move {
            test::test_immutable_ancestor_floor_beyond_commit_loc_rejected(
                ctx,
