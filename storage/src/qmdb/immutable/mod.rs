...
pub struct Immutable<E: Context, K: Key, V: VariableValue, H: CHasher, T: Translator> {
...
impl<E: Context, K: Key, V: VariableValue, H: CHasher, T: Translator> Immutable<E, K, V, H, T> {
