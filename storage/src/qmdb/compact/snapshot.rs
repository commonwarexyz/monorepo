...
///
/// Produced by a compact database's `snapshot`. It serves compact-sync state requests
...
pub struct Snapshot<F: Family, E: Context, D: Digest, Op, Cfg> {
...
impl<F, E, D, Op, Cfg> Snapshot<F, E, D, Op, Cfg>
where
    F: Family,
    E: Context,
    D: Digest,
