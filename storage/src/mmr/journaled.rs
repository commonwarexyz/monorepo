...
impl<E: RStorage + Clock + Metrics, D: Digest> CleanMmr<E, D> {
        ...
        E: BufferPooler,
    {
        let journal_cfg = JConfig {
            ...
            page_cache_page_size: cfg.config.page_cache_page_size,
            page_cache_capacity: cfg.config.page_cache_capacity,
        };
    ...
    fn test_journaled_mmr_pruning() {
        ...
        executor.start(|context| async move {
            ...
            let cfg_unpruned = Config {
                ...
                write_buffer: NZUsize!(1024),
                thread_pool: None,
                page_cache_page_size: cfg_pruned.page_cache_page_size,
                page_cache_capacity: cfg_pruned.page_cache_capacity,
            };
            ...
            dirty_pruned
                ...
                .await
                .unwrap();
            let mut pruned_mmr = dirty_pruned.merkleize(&mut hasher);
