    ...
    Variable<E, K, V, H, T>
{
    ...
    /// like `get` but returns the location of the operation that set the key's current value
    ...
    /// Update the location associated with `key` to `new_loc`.
