...
pub struct Any<E: Storage + Clock + Metrics, K: Array, V: CodecFixed, H: CHasher, T: Translator> {
...
impl<E: Storage + Clock + Metrics, K: Array, V: CodecFixed, H: CHasher, T: Translator>
    Any<E, K, V, H, T>
{
