use crate::{
    adb::{
        any::{
            variable::{init_authenticated_log, Config, Contiguous},
            OperationLog,
        },
        operation::variable::unordered::Operation,
        store::Db,
        Error,
    },
...
type AnyLog<E, K, V, H, T> =
    OperationLog<E, Contiguous<E, Operation<K, V>>, Operation<K, V>, Index<T, Location>, H, T>;
