    ...
    Immutable<E, K, V, H, T>
{
    ...
    /// OperationPruned error if loc precedes the oldest retained location. The location is
    ...
    /// matches `key`, or return OperationPruned if the location precedes the oldest retained.
