    ...
    > Current<E, K, V, H, T, N>
{
    ...
    pub fn verify_range_proof(
        ...
        let start_chunk_loc = start_loc.as_u64() / MerkleizedBitMap::<H, N>::CHUNK_SIZE_BITS;
    ...
    pub fn verify_key_value_proof(
        ...
        let num = info.loc.as_u64() / MerkleizedBitMap::<H, N>::CHUNK_SIZE_BITS;
        let mut verifier = GraftingVerifier::<H>::new(
            Self::grafting_height(),
            Location::new(num),
            vec![&info.chunk],
        ...
        // the mmr.
        if info.loc.as_u64() / MerkleizedBitMap::<H, N>::CHUNK_SIZE_BITS
