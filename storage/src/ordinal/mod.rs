    ...
    fn test_invalid_record() {
        ...
        executor.start(|context| async move {
            ...
            // Corrupt the data
            {
                ...
                blob.write_at_with(32, vec![0xFF], WriteOptions::SYNC)
                    .await
                    .unwrap();
            }
    ...
    fn test_partial_record_write() {
        ...
        executor.start(|context| async move {
            ...
            // Corrupt by writing partial record (only value, no CRC)
            {
                ...
                blob.write_at_with(36, vec![0xFF; 32], WriteOptions::SYNC)
                    .await
                    .unwrap();
            }
    ...
    fn test_corrupted_value() {
        ...
        executor.start(|context| async move {
            ...
            // Corrupt the value portion of a record
            {
                ...
                blob.write_at_with(10, hex!("0xFFFFFFFF").to_vec(), WriteOptions::SYNC)
                    .await
                    .unwrap();
            }
        ...
        executor.start(|context| async move {
            ...
            // Corrupt CRCs in different blobs
            {
                ...
                let (blob, _) = context
                    ...
                    .await
                    .unwrap();
                blob.write_at_with(5, vec![0xFF; 4], WriteOptions::SYNC)
                    .await
    ...
    fn test_zero_filled_records() {
        ...
        executor.start(|context| async move {
            ...
            // Create blob with zero-filled space
            {
                ...
                blob.write_at_with(0, zeros, WriteOptions::SYNC)
                    .await
                    .unwrap();
                ...
                blob.write_at_with(36 * 5, valid_record, WriteOptions::SYNC)
                    .await
                    .unwrap();
            }
    ...
    fn test_init_corrupted_records() {
        ...
        executor.start(|context| async move {
            ...
            // Corrupt record at index 2
            {
                ...
                blob.write_at_with(offset, vec![0xFF], WriteOptions::SYNC)
                    .await
                    .unwrap();
            }
