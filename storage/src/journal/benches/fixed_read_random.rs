use crate::{
    append_fixed_random_data, get_fixed_journal, HOT_PAGE_CACHE_SIZE, PAGE_CACHE_SIZE, PAGE_SIZE,
};
...
const WARM_STRIDE: usize = (PAGE_SIZE.get() as usize) / ITEM_SIZE;
...
async fn warm_page_cache(journal: &mut Journal<Context, FixedBytes<ITEM_SIZE>>) {
                        ...
                        b.to_async(&runner).iter_custom(|iters| async move {
                            ...
                            for _ in 0..iters {
                                ...
                                match mode {
                                    ...
                                    "concurrent" => {
                                        bench_run_concurrent(&mut j, items_to_read).await
                                    }
