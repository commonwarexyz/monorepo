...
//!     // Create a page cache
//!     let page_cache = CacheRef::from_pooler_physical(&context, NZU16!(1024), NZUsize!(10));
//!
//!     // Create a journal
...
enum ItemInfo {
    ...
    Incomplete {
        ...
        ///
        /// We carry this in the incomplete case to compute the read offset for the
...
mod tests {
    ...
    fn test_journal_varint_spanning_page_boundary() {
        ...
        const SMALL_PAGE: NonZeroU16 = NZU16!(28);
        ...
        executor.start(|context| async move {
            let cfg = Config {
                ...
                compression: None,
                codec_config: (),
                page_cache: CacheRef::from_pooler_physical(&context, SMALL_PAGE, PAGE_CACHE_SIZE),
                write_buffer: NZUsize!(1024),
            };
