...
//!     // Create a page cache
//!     let page_cache = CacheRef::from_pooler(context.with_label("cache"), NZU16!(1024), NZUsize!(10));
//!
//!     // Create a journal
    ...
    fn test_journal_varint_spanning_page_boundary() {
        ...
        executor.start(|context| async move {
            let cfg = Config {
                ...
                compression: None,
                codec_config: (),
                page_cache: CacheRef::from_pooler(context.clone(), SMALL_PAGE, PAGE_CACHE_SIZE),
                write_buffer: NZUsize!(1024),
            };
