...
pub struct Config<C> {
    ...
    /// Page cache page size for index journal caching.
    pub index_page_cache_page_size: NonZeroU16,
    /// Page cache capacity for index journal caching.
    pub index_page_cache_capacity: NonZeroUsize,
    ...
    Oversized<E, I, V>
{
    ...
    pub async fn init(context: E, cfg: Config<V::Cfg>) -> Result<Self, Error> {
        ...
        let index_cfg = FixedConfig {
            ...
            page_cache_page_size: cfg.index_page_cache_page_size,
            page_cache_capacity: cfg.index_page_cache_capacity,
...
mod tests {
    ...
    use commonware_runtime::{deterministic, Blob as _, Buf, BufMut, Metrics, Runner};
    ...
    fn test_cfg() -> Config<()> {
        Config {
            ...
            index_page_cache_page_size: NZU16!(64),
            index_page_cache_capacity: NZUsize!(8),
    ...
    fn test_recovery_corrupted_last_index_entry() {
        ...
        executor.start(|context| async move {
            ...
            let cfg = Config {
                index_partition: "test_index".to_string(),
                value_partition: "test_values".to_string(),
                index_page_cache_page_size: NZU16!(TestEntry::SIZE as u16),
                index_page_cache_capacity: NZUsize!(8),
                index_write_buffer: NZUsize!(1024),
                value_write_buffer: NZUsize!(1024),
                compression: None,
