...
mod tests {
    ...
    fn test_fixed_journal_init_conflicting_partitions() {
        ...
        executor.start(|context| async move {
            ...
            legacy_blob
                .write_at_with(0, vec![0u8; 1], WriteOptions::SYNC)
                .await
    ...
    fn test_fixed_journal_replay() {
        ...
        executor.start(|context| async move {
            ...
            blob.write_at_with(1, bad_bytes.to_be_bytes().to_vec(), WriteOptions::SYNC)
                .await
    ...
    fn test_fixed_replay_stops_after_error() {
        ...
        executor.start(|context| async move {
            ...
            let (blob, _) = context
                ...
                .await
                .unwrap();
            blob.write_at_with(1, 123456789u32.to_be_bytes().to_vec(), WriteOptions::SYNC)
                .await
                .unwrap();
    ...
    fn test_fixed_journal_clear_intent_skips_corrupt_stale_blobs() {
        ...
        executor.start(|context| async move {
            ...
            blob.write_at_with(0, vec![1, 2, 3], WriteOptions::SYNC)
                .await
                .unwrap();
            drop(blob);
