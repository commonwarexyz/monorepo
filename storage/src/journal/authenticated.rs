...
mod private {
    ...
    /// Merkle-family structure. Supports creating proofs that an item is in the journal at a
    /// given location.
    ...
    S: Strategy,
{
    ...
    async fn replay(
        ...
        self.items.replay(start_pos, buffer, read_options).await
    }
}
    ...
    H: Hasher,
{
    ...
    fn replay(
        ...
        >,
    > + Send {
        self.items.replay(start_pos, buffer, read_options)
    }
}
