...
where
    ...
    C: Contiguous<Item: Encode + Send + Sync>,
    H: Hasher,
{
...
where
    E: Storage + Clock + Metrics,
    C: MutableContiguous<Item: Encode + Send + Sync>,
    H: Hasher,
    S: State<DigestOf<H>> + Send + Sync,
{
...
where
    E: Storage + Clock + Metrics,
    C: Contiguous<Item: Encode + Send + Sync> + Persistable<Error = JournalError>,
    H: Hasher,
    S: State<DigestOf<H>> + Send + Sync,
{
