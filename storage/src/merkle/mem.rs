...
/// deque. Pruned nodes precede `pruning_boundary` and are no longer stored unless they are part of
/// the pruning-boundary pinned-node set, in which case they are kept in `pinned_nodes`.
///
