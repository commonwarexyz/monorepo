...
mod tests {
    ...
    #[test_traced]
    fn test_determinism() {
        // Test determinism by running the same set of operations and ensuring the same result.
        let output1 = test_metadata_operations_and_restart(100);
        let output2 = test_metadata_operations_and_restart(100);
