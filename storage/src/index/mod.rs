...
//!
//! Keys are translated into a compressed, fixed-size representation using a [crate::translator::Translator]. Depending
//! on the size of the representation, this can lead to a non-negligible number of collisions (even
//! if the original keys are collision-free). To workaround this issue, [Index::get] returns all values
