...
commonware_macros::stability_scope!(BETA {
    ...
    /// In other words, `hasher.clone()` is equivalent to `Self::default()`; callers
    /// must not rely on cloning to duplicate partially-updated state.
    pub trait Hasher: Clone + Default + Send + Sync + 'static {
