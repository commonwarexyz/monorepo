...
pub trait Verifier: CryptoPrimitives + Clone + Send + Sync + 'static {
...
pub trait Signer: CryptoPrimitives + Clone + Send + Sync + 'static {
...
mod tests {
    ...
    #[test]
    fn test_ed25519_len() {
        assert_eq!(<Ed25519 as CryptoPrimitives>::PublicKey::LEN_ENCODED, 32);
        assert_eq!(<Ed25519 as CryptoPrimitives>::Signature::LEN_ENCODED, 64);
    }
    ...
    fn test_bls12381_len() {
        assert_eq!(<Bls12381 as CryptoPrimitives>::PublicKey::LEN_ENCODED, 48);
        assert_eq!(<Bls12381 as CryptoPrimitives>::Signature::LEN_ENCODED, 96);
    }
    ...
    fn test_secp256r1_len() {
        assert_eq!(<Secp256r1 as CryptoPrimitives>::PublicKey::LEN_ENCODED, 33);
        assert_eq!(<Secp256r1 as CryptoPrimitives>::Signature::LEN_ENCODED, 64);
    }
