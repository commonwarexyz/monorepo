...
fn benchmark_threshold_batch_verify_public_keys(c: &mut Criterion) {
                ...
                |b| {
                    b.iter_batched(
                        ...
                        |(mut rng, polynomial, mut signatures)| {
                            ...
                            // Verify
                            let result =
                                black_box(primitives::ops::threshold::batch_verify_public_keys::<
                                    _,
                                    MinSig,
                                    _,
                                >(
...
criterion_group! {
    ...
    targets = benchmark_threshold_batch_verify_public_keys
}
