...
//!
//! ```txt
//! dkg: conc=1 n=5 t=2     time:   [2.7610 µs 2.8205 µs 2.8763 µs]
//! dkg: conc=1 n=10 t=4    time:   [9.0694 µs 9.1342 µs 9.1727 µs]
//! dkg: conc=1 n=20 t=7    time:   [26.200 µs 26.328 µs 26.516 µs]
//! dkg: conc=1 n=50 t=17   time:   [138.97 µs 139.60 µs 140.10 µs]
//! dkg: conc=1 n=100 t=34  time:   [538.38 µs 539.65 µs 541.33 µs]
//! dkg: conc=1 n=250 t=84  time:   [3.4278 ms 3.4504 ms 3.4724 ms]
//! dkg: conc=1 n=500 t=167 time:   [13.316 ms 13.387 ms 13.465 ms]
//! ```
//!
//! ## DKG Reshare Recovery (Contributor)
//!
//! ```txt
//! reshare: conc=1 n=5 t=2         time:   [149.16 µs 149.59 µs 149.93 µs]
//! reshare: conc=2 n=5 t=2         time:   [98.315 µs 100.03 µs 101.60 µs]
//! reshare: conc=4 n=5 t=2         time:   [123.41 µs 124.70 µs 126.02 µs]
//! reshare: conc=8 n=5 t=2         time:   [171.07 µs 171.62 µs 172.38 µs]
//! reshare: conc=1 n=10 t=4        time:   [513.59 µs 514.92 µs 516.07 µs]
//! reshare: conc=2 n=10 t=4        time:   [289.33 µs 289.80 µs 290.16 µs]
//! reshare: conc=4 n=10 t=4        time:   [194.84 µs 204.51 µs 217.60 µs]
//! reshare: conc=8 n=10 t=4        time:   [248.80 µs 254.10 µs 256.54 µs]
//! reshare: conc=1 n=20 t=7        time:   [1.3599 ms 1.3609 ms 1.3620 ms]
//! reshare: conc=2 n=20 t=7        time:   [812.24 µs 815.59 µs 818.17 µs]
//! reshare: conc=4 n=20 t=7        time:   [467.86 µs 468.96 µs 470.35 µs]
//! reshare: conc=8 n=20 t=7        time:   [494.17 µs 496.83 µs 499.32 µs]
//! reshare: conc=1 n=50 t=17       time:   [8.9180 ms 9.2827 ms 9.7243 ms]
//! reshare: conc=2 n=50 t=17       time:   [4.8345 ms 4.8378 ms 4.8404 ms]
//! reshare: conc=4 n=50 t=17       time:   [2.8024 ms 2.8074 ms 2.8108 ms]
//! reshare: conc=8 n=50 t=17       time:   [1.8140 ms 1.8219 ms 1.8301 ms]
//! reshare: conc=1 n=100 t=34      time:   [39.960 ms 40.785 ms 42.373 ms]
//! reshare: conc=2 n=100 t=34      time:   [20.347 ms 20.358 ms 20.371 ms]
//! reshare: conc=4 n=100 t=34      time:   [11.211 ms 11.276 ms 11.354 ms]
//! reshare: conc=8 n=100 t=34      time:   [6.9775 ms 7.4456 ms 8.3087 ms]
//! reshare: conc=1 n=250 t=84      time:   [290.29 ms 291.91 ms 295.00 ms]
//! reshare: conc=2 n=250 t=84      time:   [148.39 ms 148.51 ms 148.64 ms]
//! reshare: conc=4 n=250 t=84      time:   [77.728 ms 78.242 ms 78.747 ms]
//! reshare: conc=8 n=250 t=84      time:   [47.123 ms 47.732 ms 48.640 ms]
//! reshare: conc=1 n=500 t=167     time:   [1.4806 s 1.5021 s 1.5357 s]
//! reshare: conc=2 n=500 t=167     time:   [747.69 ms 759.86 ms 779.92 ms]
//! reshare: conc=4 n=500 t=167     time:   [392.03 ms 393.94 ms 395.93 ms]
//! reshare: conc=8 n=500 t=167     time:   [232.44 ms 238.31 ms 247.56 ms]
//! ```
//!
