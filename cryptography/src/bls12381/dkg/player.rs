...
impl<V: Variant> FinalizeInput<V> {
    ...
    pub fn with_group_poly(mut self, group_poly: poly::Public<V>) -> Self {
        self.group_poly = Some(group_poly);
        self
    }
    pub fn with_weights(mut self, weights: BTreeMap<u32, Weight>) -> Self {
