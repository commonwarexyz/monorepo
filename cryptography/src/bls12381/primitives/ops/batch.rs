...
//! which requires predicting the weights before they're generated (probability approximately
//! `2^-128` per batch check). The weights must be generated securely and remain unpredictable to
//! the attacker.
#[stability(ALPHA)]
