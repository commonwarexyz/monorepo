...
pub const PARTIAL_SIGNATURE_LENGTH: usize = u32::LEN_CODEC + group::SIGNATURE_LENGTH;
...
impl<C: Element> Eval<C> {
    ...
    pub fn serialize(&self) -> Vec<u8> {
        ...
        let mut bytes = Vec::with_capacity(u32::LEN_CODEC + value_serialized.len());
    ...
    pub fn deserialize(bytes: &[u8]) -> Option<Self> {
        ...
        let value = C::deserialize(&bytes[u32::LEN_CODEC..])?;
