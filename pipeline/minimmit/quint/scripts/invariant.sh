...
DEFAULT_INVARIANTS="no_proposal_equivocation,block_commits_to_parent,agreement,no_vote_equivocation_inv,contradiction_nullify_is_justified,no_nullification_and_finalization_in_the_same_view,validity,finalization_agreement,valid_last_finalized,certificates_are_valid_inv,certificates_are_backed,notarized_consistency,safe_finalization,committed_blocks_are_finalized,committed_chain_is_connected,last_finalized_is_committed,finalized_blocks_are_committed_or_pending,pending_finalization_agreement,no_nullification_and_finalization_globally"
