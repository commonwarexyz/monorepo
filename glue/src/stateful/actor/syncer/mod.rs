...
/// state sync for this partition and must recover from marshal or the stored
/// height on future startups instead of running state sync again.
...
/// from the later of this height and marshal's processed height. This action is
/// irreversible.
    ...
    V: Variant<ApplicationBlock = A::Block>,
{
    ...
    let marshal_floor = skip_finalized_until
        .or(processed_height)
