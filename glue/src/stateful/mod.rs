...
mod wrapper;
pub use wrapper::{Config, Stateful};
    ...
    E: Rng + Spawner + Metrics + Clock,
{
    ...
    /// The marshal variant that provides commitment extraction for blocks.
    ///
    /// The variant's [`Variant::commitment`] and
    /// [`Variant::parent_commitment`] are used by the wrapper to key
    /// pending state. [`Variant::commitment_to_inner`] converts
    /// commitments back to block digests for fetching finalized blocks.
    type MarshalVariant: Variant<Block = Self::Block>;
