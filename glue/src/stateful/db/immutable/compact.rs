    ...
    Operation<F, K, FixedEncoding<V>>: EncodeShared + CodecRead<Cfg = ()>,
{
    ...
    type Snapshot = Arc<StateSnapshot<F, E, H::Digest, Operation<F, K, FixedEncoding<V>>, ()>>;
    ...
    S: Strategy,
{
    ...
    type SyncTarget = sync::compact::Target<F, H::Digest>;
    type Snapshot = Arc<StateSnapshot<F, E, H::Digest, Operation<F, K, VariableEncoding<V>>, C>>;
