...
lint: check-fmt check-toml-fmt clippy check-docs check-features dylint check-publish-order check-properties check-stability
...
# Check that every test cited in consensus/src/multimmit/docs/PROPERTIES.md exists
check-properties:
    python3 .github/scripts/check_properties.py
