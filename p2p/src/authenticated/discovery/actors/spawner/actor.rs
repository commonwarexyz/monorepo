...
pub struct Actor<E: Spawner + Timer + CryptoRngCore + Metrics, O: Sink, I: Stream, C: PublicKey> {
...
impl<E: Spawner + Timer + CryptoRngCore + Metrics, O: Sink, I: Stream, C: PublicKey>
    Actor<E, O, I, C>
{
