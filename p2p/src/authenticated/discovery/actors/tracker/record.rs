...
mod tests {
    ...
    fn test_unknown_initial_state() {
        let record = Record::<secp256r1::standard::PublicKey>::unknown();
    ...
    fn test_myself_initial_state() {
        let my_info = create_peer_info::<secp256r1::standard::PrivateKey>(0, test_socket(), 100);
        let record = Record::<secp256r1::standard::PublicKey>::myself(my_info.clone());
        assert!(
    ...
    fn test_bootstrapper_initial_state() {
        ...
        let record = Record::<secp256r1::standard::PublicKey>::bootstrapper(socket);
    ...
    fn test_unknown_to_discovered() {
        let socket = test_socket();
        let mut record = Record::<secp256r1::standard::PublicKey>::unknown();
        let peer_info = create_peer_info::<secp256r1::standard::PrivateKey>(1, socket, 1000);
    ...
    fn test_bootstrapper_to_discovered() {
        let socket = test_socket();
        let mut record = Record::<secp256r1::standard::PublicKey>::bootstrapper(socket);
        let peer_info = create_peer_info::<secp256r1::standard::PrivateKey>(2, socket, 1000);
    ...
    fn test_discovered_update_newer_timestamp() {
        let socket = test_socket();
        let mut record = Record::<secp256r1::standard::PublicKey>::unknown();
        let peer_info_old = create_peer_info::<secp256r1::standard::PrivateKey>(3, socket, 1000);
        let peer_info_new = create_peer_info::<secp256r1::standard::PrivateKey>(3, socket, 2000);
    ...
    fn test_discovered_no_update_older_or_equal_timestamp() {
        let socket = test_socket();
        let mut record = Record::<secp256r1::standard::PublicKey>::unknown();
        let peer_info_current =
            create_peer_info::<secp256r1::standard::PrivateKey>(5, socket, 1000);
        let peer_info_older = create_peer_info::<secp256r1::standard::PrivateKey>(5, socket, 500);
        let peer_info_equal = create_peer_info::<secp256r1::standard::PrivateKey>(5, socket, 1000);
    ...
    fn test_update_myself_and_blocked() {
        ...
        let other_info =
            create_peer_info::<secp256r1::standard::PrivateKey>(1, test_socket2(), 200);
        let newer_my_info =
            create_peer_info::<secp256r1::standard::PrivateKey>(0, test_socket(), 300);
        ...
        let mut record_blocked = Record::<secp256r1::standard::PublicKey>::unknown();
    ...
    fn test_update_with_different_public_key() {
        ...
        let peer_info_pk1_ts1000 =
            create_peer_info::<secp256r1::standard::PrivateKey>(10, socket, 1000);
        let peer_info_pk2_ts2000 =
            create_peer_info::<secp256r1::standard::PrivateKey>(11, socket, 2000);
    ...
    fn test_increment_decrement_and_deletable() {
        ...
        let mut record_unknown = Record::<secp256r1::standard::PublicKey>::unknown();
        ...
        let peer_info = create_peer_info::<secp256r1::standard::PrivateKey>(7, test_socket(), 1000);
        let mut record_disc = Record::<secp256r1::standard::PublicKey>::unknown();
        ...
        let mut record_boot = Record::<secp256r1::standard::PublicKey>::bootstrapper(test_socket());
    ...
    fn test_block_behavior_and_persistence() {
        let sample_peer_info =
            create_peer_info::<secp256r1::standard::PrivateKey>(20, test_socket(), 1000);
        ...
        let mut record_disc_from_boot =
            Record::<secp256r1::standard::PublicKey>::bootstrapper(test_socket());
        ...
        let mut record_reserved = Record::<secp256r1::standard::PublicKey>::unknown();
        ...
        let mut record_active = Record::<secp256r1::standard::PublicKey>::unknown();
    ...
    fn test_block_myself_and_already_blocked() {
        ...
        let mut record_to_be_blocked = Record::<secp256r1::standard::PublicKey>::unknown();
    ...
    fn test_sharable_logic() {
        let socket = test_socket();
        let peer_info_data = create_peer_info::<secp256r1::standard::PrivateKey>(12, socket, 100);

        // Unknown: Not sharable
        let record_unknown = Record::<secp256r1::standard::PublicKey>::unknown();
        ...
        let record_boot = Record::<secp256r1::standard::PublicKey>::bootstrapper(socket);
    ...
    fn test_dial_failure_and_dial_success() {
        let socket = test_socket();
        let peer_info = create_peer_info::<secp256r1::standard::PrivateKey>(18, socket, 1000);
        let mut record = Record::<secp256r1::standard::PublicKey>::unknown();
    ...
    fn test_want_logic_with_min_fails() {
        let socket = test_socket();
        let peer_info = create_peer_info::<secp256r1::standard::PrivateKey>(13, socket, 100);
        let min_fails = 2;

        // Unknown and Bootstrapper always want info
        assert!(Record::<secp256r1::standard::PublicKey>::unknown().want(min_fails));
        assert!(Record::<secp256r1::standard::PublicKey>::bootstrapper(socket).want(min_fails));

        // Myself and Blocked never want info
        assert!(!Record::myself(peer_info.clone()).want(min_fails));
        let mut blocked = Record::<secp256r1::standard::PublicKey>::unknown();
        blocked.block();
    ...
    fn test_deletable_logic_detailed() {
        let peer_info = create_peer_info::<secp256r1::standard::PrivateKey>(14, test_socket(), 100);

        // Persistent records are never deletable regardless of sets count
        assert!(!Record::myself(peer_info.clone()).deletable());
        assert!(!Record::<secp256r1::standard::PublicKey>::bootstrapper(test_socket()).deletable());
        let mut record_pers = Record::<secp256r1::standard::PublicKey>::bootstrapper(test_socket());
        ...
        let mut record = Record::<secp256r1::standard::PublicKey>::unknown(); // Not persistent
        assert_eq!(record.sets, 0);
        assert_eq!(record.status, Status::Inert);
    ...
    fn test_allowed_logic_detailed() {
        let peer_info = create_peer_info::<secp256r1::standard::PrivateKey>(16, test_socket(), 100);
        ...
        assert!(Record::<secp256r1::standard::PublicKey>::bootstrapper(test_socket()).allowed());
        let mut record_pers = Record::<secp256r1::standard::PublicKey>::bootstrapper(test_socket());
        assert!(record_pers.update(peer_info.clone()));
