...
mod tests {
    ...
    use commonware_utils::{bitmap::BitMap, ordered::Set, NZU32};
    ...
    fn test_connect_authorized_peer_receives_tracker_info() {
        ...
        executor.start(|context| async move {
            ...
            oracle
                .update(0, Set::from([tracker_pk.clone(), auth_pk.clone()]))
                .await;
    ...
    fn test_handle_bit_vec_for_unknown_index_sends_no_peers() {
        ...
        executor.start(|context| async move {
            ...
            oracle.update(0, Set::from([tracker_pk, pk1.clone()])).await;
            context.sleep(Duration::from_millis(10)).await;
    ...
    fn test_block_peer_standard_behavior() {
        ...
        executor.start(|context| async move {
            ...
            oracle
                .update(0, Set::from([tracker_pk.clone(), pk1.clone()]))
                .await;
            context.sleep(Duration::from_millis(10)).await;
    ...
    fn test_handle_peers_learns_unknown_peer() {
        ...
        executor.start(|context| async move {
            ...
            let set1 = Set::from([tracker_pk.clone(), pk1.clone(), pk2.clone()]);
    ...
    fn test_handle_peers_rejects_older_info_for_known_peer() {
        ...
        executor.start(|context| async move {
            ...
            let peer_set_0_peers = Set::from([tracker_pk.clone(), pk1.clone(), pk2.clone()]);
    ...
    fn test_listenable() {
        ...
        executor.start(|context| async move {
            ...
            oracle
                .update(0, Set::from([peer_pk.clone(), peer_pk2.clone()]))
                .await;
            context.sleep(Duration::from_millis(10)).await;
    ...
    fn test_listen() {
        ...
        executor.start(|context| async move {
            ...
            oracle.update(0, Set::from([peer_pk.clone()])).await;
    ...
    fn test_bitvec_kill_on_length_mismatch() {
        ...
        executor.start(|context| async move {
            ...
            oracle
                .update(0, Set::from([tracker_pk, pk1.clone(), pk2.clone()]))
                .await;
            context.sleep(Duration::from_millis(10)).await;
    ...
    fn test_bit_vec_comprehensive() {
        ...
        executor.start(|context| async move {
            ...
            let set0_peers = Set::from([tracker_pk.clone(), peer1_pk.clone(), peer2_pk.clone()]);
            ...
            let set1_peers = Set::from([tracker_pk.clone(), peer2_pk.clone()]); // New set without peer1
            oracle.update(1, set1_peers.clone()).await;
            context.sleep(Duration::from_millis(10)).await;

            let set2_peers = Set::from([tracker_pk.clone(), peer3_pk.clone()]); // Another new set without peer1
