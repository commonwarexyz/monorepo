...
pub enum Message<E: Spawner + Clock, Si: Sink, St: Stream, P: Component> {
    Spawn {
        peer: P,
...
pub struct Mailbox<E: Spawner + Clock, Si: Sink, St: Stream, P: Component> {
    sender: mpsc::Sender<Message<E, Si, St, P>>,
}

impl<E: Spawner + Clock, Si: Sink, St: Stream, P: Component> Mailbox<E, Si, St, P> {
...
impl<E: Spawner + Clock, Si: Sink, St: Stream, P: Component> Clone for Mailbox<E, Si, St, P> {
    /// Clone the mailbox.
    ///
