...
mod tests {
    ...
    fn test_block_peer_standard_behavior() {
        ...
        executor.start(|context| async move {
            ...
            oracle
                .register(0, OrderedWrapped::from(vec![(pk.clone(), addr)]))
                .await;
    ...
    fn test_block_peer_already_blocked_is_noop() {
        ...
        executor.start(|context| async move {
            ...
            let addr = SocketAddr::new(Ipv4Addr::LOCALHOST.into(), 1001);
            oracle
                .register(0, OrderedWrapped::from(vec![(pk1.clone(), addr)]))
                .await;
            context.sleep(Duration::from_millis(10)).await;
    ...
    fn test_listen() {
        ...
        executor.start(|context| async move {
            ...
            oracle
                .register(0, OrderedWrapped::from(vec![(peer_pk.clone(), peer_addr)]))
                .await;
    ...
    fn test_dialable_message() {
        ...
        executor.start(|context| async move {
            ...
            oracle
                .register(0, OrderedWrapped::from(vec![(boot_pk.clone(), boot_addr)]))
                .await;
    ...
    fn test_register_disconnects_removed_peers() {
        ...
        executor.start(|context| async move {
            ...
            oracle
                .register(
                    0,
                    OrderedWrapped::from(vec![(my_pk.clone(), my_addr), (pk_1.clone(), addr_1)]),
                )
                .await;
            // let the register take effect
            context.sleep(Duration::from_millis(10)).await;
            ...
            oracle
                .register(1, OrderedWrapped::from(vec![(pk_2.clone(), addr_2)]))
                .await;
