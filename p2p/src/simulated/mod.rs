...
mod tests {
    ...
    fn test_add_link_before_channel_registration() {
        ...
        executor.start(|context| async move {
            ...
            let mut manager = oracle.manager();
            manager
                .register(0, vec![pk1.clone(), pk2.clone()].try_into().unwrap())
                .await;
    ...
    fn register_peer_set() {
        ...
        executor.start(|context| async move {
            ...
            let pk2 = PrivateKey::from_seed(2).public_key();
            manager
                .register(0xFF, [pk1.clone(), pk2.clone()].try_into().unwrap())
                .await;
    ...
    fn test_socket_manager() {
        ...
        executor.start(|context| async move {
            ...
            let peers: Map<_, _> = [(pk1.clone(), addr1.clone()), (pk2.clone(), addr2.clone())]
                .try_into()
                .unwrap();
            manager.register(1, peers).await;
            ...
            manager.register(2, peers).await;
    ...
    fn test_peer_set_window_management() {
        ...
        executor.start(|context| async move {
            ...
            let mut manager = oracle.manager();
            manager
                .register(1, vec![pk1.clone(), pk2.clone()].try_into().unwrap())
                .await;
            ...
            manager
                .register(2, vec![pk2.clone(), pk3.clone()].try_into().unwrap())
                .await;
            ...
            manager
                .register(3, vec![pk3.clone(), pk4.clone()].try_into().unwrap())
                .await;
    ...
    fn test_sender_removed_from_tracked_peer_set_drops_message() {
        ...
        executor.start(|context| async move {
            ...
            manager
                .register(2, vec![recipient_pk.clone(), other_pk].try_into().unwrap())
                .await;
            let (id, _, _) = subscription.recv().await.unwrap();
            assert_eq!(id, 2);
    ...
    fn test_subscribe_to_peer_sets() {
        ...
        executor.start(|context| async move {
            ...
            manager
                .register(3, vec![pk1.clone(), pk3.clone()].try_into().unwrap())
                .await;
            ...
            manager
                .register(4, vec![pk1.clone(), pk3.clone()].try_into().unwrap())
                .await;
    ...
    fn test_multiple_subscriptions() {
        ...
        executor.start(|context| async move {
            ...
            // Register another peer set
            manager
                .register(2, vec![pk1.clone(), pk2.clone()].try_into().unwrap())
                .await;
    ...
    fn test_subscription_includes_self_when_registered() {
        ...
        executor.start(|context| async move {
            ...
            manager
                .register(1, vec![other_pk.clone()].try_into().unwrap())
                .await;
    ...
    fn test_operations_after_shutdown_do_not_panic() {
        ...
        executor.start(|context| async move {
            ...
            manager.register(1, [pk1.clone()].try_into().unwrap()).await;
    ...
    fn test_socket_manager_overwrite() {
        ...
        executor.start(|context| async move {
            ...
            .try_into()
            .unwrap();
            socket_manager.register(0, peers).await;
