...
pub struct Network<E: RNetwork<Listener, Sink, Stream> + Spawner + Rng + Clock, P: FormattedBytes> {
    runtime: E,
...
impl<E: RNetwork<Listener, Sink, Stream> + Spawner + Rng + Clock, P: FormattedBytes> Network<E, P> {
...
impl Link {
    fn new<E: Spawner + RNetwork<Listener, Sink, Stream>, P: FormattedBytes>(
        runtime: &mut E,
        dialer: P,
        socket: SocketAddr,
        sampler: Normal<f64>,
