...
SKIP_REGEX="commonware-bridge|commonware-chat|commonware-terminal|commonware-estimator|commonware-flood|commonware-log|commonware-reshare|commonware-bench|commonware-conformance|commonware-deployer|-fuzz$|-macros$"
