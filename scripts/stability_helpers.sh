...
SKIP_REGEX="commonware-bridge|commonware-chat|commonware-estimator|commonware-flood|commonware-log|commonware-reshare|commonware-bench|commonware-conformance|commonware-deployer|-fuzz$|-fuzz-|-macros$"
