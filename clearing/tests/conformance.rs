...
use commonware_clearing::bajillion::{
    ...
    transition::{
        BatchId, CloseContext, CloseLimits, EpochContext, Header, ProposalId, RootBundle,
...
commonware_conformance::conformance_tests! {
    ...
    CodecConformance<ActivityRecord<VerifyingKey, Sha256Digest>> => 1024,
    CodecConformance<LogHead<Sha256Digest>>,
    CodecConformance<Heads<Sha256Digest>>,
    CodecConformance<Floors>,
    CodecConformance<LogOpening<Sha256Digest>> => 1024,
    CodecConformance<SourceMetadata<VerifyingKey, Sha256Digest>> => 1024,
    CodecConformance<SourceRow<VerifyingKey>> => 1024,
    CodecConformance<SourceProof<Sha256Digest>> => 1024,
    CodecConformance<ProposalId<Sha256Digest>>,
}
