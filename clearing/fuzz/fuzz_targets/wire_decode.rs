...
fuzz_target!(|data: &[u8]| {
    ...
    match selector % 52 {
        ...
        8 | 44 => roundtrip::<StateRoot<Digest>>(bytes, &()),
        9 | 45 => roundtrip::<StateValueOpening<Digest>>(bytes, &item_limit),
        10 | 47 => roundtrip::<CloseAmounts>(bytes, &()),
        ...
        17 | 18 => roundtrip::<Opening<Digest>>(bytes, &()),
        ...
        29 | 32 => roundtrip::<StateLookup<Digest>>(bytes, &item_limit),
        30 => roundtrip::<CloseContext<VerifyingKey, Digest>>(bytes, &()),
        31 | 46 => roundtrip::<StateOpening<VerifyingKey, Digest>>(bytes, &item_limit),
