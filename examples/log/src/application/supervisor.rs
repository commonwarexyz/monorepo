use commonware_consensus::{
    ...
    Reporter, Supervisor as Su, Viewable,
};
...
#[derive(Clone)]
pub struct Supervisor<P: PublicKey, S: Signature, D: Digest> {
    participants: Vec<P>,
...
impl<P: PublicKey, S: Signature, D: Digest> Supervisor<P, S, D> {
...
impl<P: PublicKey, S: Signature, D: Digest> Su for Supervisor<P, S, D> {
    type Index = View;
    type PublicKey = P;
...
impl<P: PublicKey, S: Signature, D: Digest> Reporter for Supervisor<P, S, D> {
