...
pub fn payload<P: FormattedArray>(round: u64, dealer: &P, commitment: &[u8]) -> Vec<u8> {
    let mut payload = Vec::with_capacity(u64::SERIALIZED_LEN + P::SERIALIZED_LEN + commitment.len());
