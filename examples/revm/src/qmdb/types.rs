...
use commonware_storage::{
    qmdb::{current, current::db::Unmerkleized, NonDurable},
    translator::EightCap,
};
...
pub(crate) type AccountStore = current::ordered::variable::Db<
    Context,
    AccountKey,
    AccountRecord,
    QmdbHasher,
    ...
    CURRENT_CHUNK_SIZE,
>;
pub(crate) type StorageStore = current::ordered::variable::Db<
    Context,
    StorageKey,
    StorageRecord,
    QmdbHasher,
    ...
    CURRENT_CHUNK_SIZE,
>;
pub(crate) type CodeStore = current::ordered::variable::Db<
    Context,
    CodeKey,
    Vec<u8>,
    QmdbHasher,
