...
mod tests {
    ...
    fn test_conformity() {
        ...
        // little-endian: 0xABCD -> [0xCD, 0xAB], 0xDEADBEEF -> [0xEF, 0xBE, 0xAD, 0xDE]
        assert_eq!(t2.encode(), &[0xCD, 0xAB, 0x00, 0xEF, 0xBE, 0xAD, 0xDE][..]);
        ...
        // Some -> 0x01
        // 0x1234u16 -> 0x34, 0x12 (little-endian)
        // 0xFFu8 -> 0xFF
        assert_eq!(t_option_some.encode(), &[0x01, 0x34, 0x12, 0xFF][..]);
