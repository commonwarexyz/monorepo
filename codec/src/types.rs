...
mod tests {
            ...
            paste! {
                ...
                fn [<test_ $type>]() {
                    ...
                    for value in values.iter() {
                        ...
                        let decoded = <$type>::decode::<Bytes>(encoded).unwrap();
                        ...
                        let decoded = <$type>::decode::<Bytes>(Bytes::copy_from_slice(&fixed)).unwrap();
                        assert_eq!(*value, decoded);
                    }
                }
            }
    ...
    fn test_bool() {
        ...
        for value in values.iter() {
            ...
            let decoded = bool::decode::<BytesMut>(encoded).unwrap();
            assert_eq!(*value, decoded);
    ...
    fn test_bytes() {
        ...
        for value in values {
            ...
            let decoded = Bytes::decode::<BytesMut>(encoded).unwrap();
            assert_eq!(value, decoded);
        }
    }
    ...
    fn test_array() {
        ...
        let decoded = <[u8; 3]>::decode::<BytesMut>(encoded).unwrap();
    ...
    fn test_option() {
        ...
        for value in option_values {
            let encoded = value.encode();
            let decoded = Option::<u32>::decode::<BytesMut>(encoded).unwrap();
            assert_eq!(value, decoded);
        }
    }
    ...
    fn test_tuple() {
        ...
        for value in tuple_values {
            let encoded = value.encode();
            let decoded = <(u16, Option<u32>)>::decode::<BytesMut>(encoded).unwrap();
            assert_eq!(value, decoded);
        }
    }
    ...
    fn test_vec() {
        ...
        for value in vec_values {
            ...
            let decoded = Vec::<u8>::decode::<BytesMut>(encoded).unwrap();
            assert_eq!(value, decoded);
        }
    }
}
