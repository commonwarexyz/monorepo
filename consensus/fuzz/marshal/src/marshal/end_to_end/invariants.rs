...
use commonware_consensus_fuzz_core::{network::CertificatePoison, simplex::Simplex};
...
mod tests {
    ...
    use commonware_consensus_fuzz_core::{SimplexCertificateMock, simplex_certificate_mock};
