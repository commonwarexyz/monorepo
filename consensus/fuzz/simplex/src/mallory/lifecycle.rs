...
//!
//! Mallory may fault the single faultable identity ([`commonware_consensus_fuzz_core::BYZANTINE_IDX`])
...
//!   never send again, then mark it [`Crashed`](commonware_consensus_fuzz_core::ValidatorLifecycle::Crashed).
...
use commonware_consensus_fuzz_core::{ManagedValidator, simplex::Simplex};
