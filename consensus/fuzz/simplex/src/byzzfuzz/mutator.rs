...
use crate::byzzfuzz::observed::ObservedState;
use commonware_consensus::{
    Viewable,
    simplex::types::Proposal,
    types::{Epoch, Round, View},
};
use commonware_consensus_fuzz_core::{EPOCH, strategy::Strategy};
...
impl Strategy for ByzzFuzzMutator {
    ...
    fn network_faults(
        ...
        _rng: &mut impl Rng,
    ) -> Vec<(View, commonware_consensus_fuzz_core::utils::SetPartition)> {
