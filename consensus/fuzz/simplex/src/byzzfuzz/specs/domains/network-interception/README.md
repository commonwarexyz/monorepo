...
- `consensus/fuzz/simplex/src/byzzfuzz/forwarder.rs` - per-channel outbound interception.
- `consensus/fuzz/simplex/src/byzzfuzz/intercept.rs` - shared interception data types, the GST gate, the sender-round cell, and the inbound round-tracking wrapper.
- `consensus/fuzz/simplex/src/byzzfuzz/scope.rs` - message-scope matching for process faults.
- `consensus/fuzz/simplex/src/byzzfuzz/observed.rs` - observed-value pool populated by interception sites.
