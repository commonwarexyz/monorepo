...
- `consensus/fuzz/simplex/src/byzzfuzz/intercept.rs` - sender-round cell, inbound round-tracking wrapper, channel view extractors.
- `consensus/fuzz/simplex/src/byzzfuzz/forwarder.rs` - outbound sites that fold the carried view into the cell before reading it.
