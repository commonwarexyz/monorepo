...
- `consensus/fuzz/simplex/src/byzzfuzz/injector.rs` - async injector loop and per-channel dispatch.
- `consensus/fuzz/simplex/src/byzzfuzz/mutator.rs` - vote-mutation strategy (see [Mutator](mutator.md)).
- `consensus/fuzz/simplex/src/byzzfuzz/observed.rs` - observed-value pool that grounds mutations in seen protocol state.
