...
- `consensus/fuzz/simplex/src/byzzfuzz/mutator.rs` - `ByzzFuzzMutator` policy.
- `consensus/fuzz/simplex/src/byzzfuzz/observed.rs` - observed-value pool the policy draws from.
