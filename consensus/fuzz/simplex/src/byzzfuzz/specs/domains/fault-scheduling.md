...
- `consensus/fuzz/simplex/src/byzzfuzz/sampling.rs` - schedule generation.
- `consensus/fuzz/simplex/src/byzzfuzz/fault.rs` - process- and network-fault data types.
- `consensus/fuzz/simplex/src/byzzfuzz/scope.rs` - process-fault message-scope variants and scope sampler.
- `consensus/fuzz/simplex/src/byzzfuzz/runner.rs` - draws schedule bounds and post-GST extension.
- `consensus/fuzz/simplex/src/byzzfuzz/mod.rs` - exposes the fixed byzantine identity.
