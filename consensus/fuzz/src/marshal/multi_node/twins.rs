...
use commonware_consensus::{
    ...
    simplex::{Engine, Floor, Plan, config, mocks::twins, types::Context as SimplexContext},
...
trait TwinsMarshal<P: Simplex, A: TwinsBlockBuilder<P>> {
