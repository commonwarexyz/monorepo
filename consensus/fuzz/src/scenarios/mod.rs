...
//! backfill, open subscription, divergent same-height certificates, or a pending
//! floor anchor) and returning a certified floor. The fuzzing phase starts the
...
mod strategy;
#[allow(clippy::module_inception)] // the concrete scenarios live in scenarios/scenarios.rs by design.
pub(crate) mod scenarios;

pub use input::{MarshalScenarioPrefixInput, Mode, ScenarioKind};
pub use runner::fuzz_marshal_scenario_prefix;
