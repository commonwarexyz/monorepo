...
> {
    ...
    journals: BTreeMap<C::PublicKey, segmented::Journal<E, Node<C::PublicKey, V, D>>>,
    ...
    > Engine<E, C, V, D, A, R, Z, M, Su, TSu, NetS, NetR>
{
    ...
    async fn journal_prepare(&mut self, sequencer: &C::PublicKey) {
        ...
        let journal = segmented::Journal::<_, Node<C::PublicKey, V, D>>::init(
