    ...
    T: Strategy,
{
    ...
    /// delivery while waiting for local certification to determine whether it
    /// satisfies the fetch. Expiry releases that delivery for retry; it does
    /// not resolve or cancel the application certification request.
    ///
