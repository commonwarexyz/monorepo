...
impl<P: PublicKey, V: Variant> Scheme<P, V> {
    ...
    pub fn new(participants: OrderedInjection<P, V::Public>, private_key: Private) -> Self {
    ...
    /// is used for committee ordering and indexing, while the consensus key is used for
    /// verification.
    pub const fn verifier(participants: OrderedInjection<P, V::Public>) -> Self {
        Self {
            participants,
            signer: None,
        }
...
mod tests {
    ...
    fn setup_signers<V: Variant>(
        ...
        OrderedInjection<ed25519::PublicKey, V::Public>,
    ) {
