...
pub struct Config<C: Scheme, D: FormattedBytes> {
...
#[derive(Clone)]
pub struct Supervisor<C: Scheme, D: FormattedBytes> {
...
impl<C: Scheme, D: FormattedBytes> Supervisor<C, D> {
...
impl<C: Scheme, D: FormattedBytes> Su for Supervisor<C, D> {
    type Index = View;
