...
mod tests {
    ...
    mod conformance {
        ...
        commonware_codec::conformance_tests! {
            ...
            Vote<Scheme, Sha256Digest> => 1024,
            Certificate<Scheme, Sha256Digest> => 1024,
            Artifact<Scheme, Sha256Digest> => 1024,
            Proposal<Sha256Digest> => 1024,
            Notarize<Scheme, Sha256Digest> => 1024,
            Notarization<Scheme, Sha256Digest> => 1024,
            Nullify<Scheme> => 1024,
            Nullification<Scheme> => 1024,
            Finalize<Scheme, Sha256Digest> => 1024,
            Finalization<Scheme, Sha256Digest> => 1024,
            Backfiller<Scheme, Sha256Digest> => 1024,
            Request => 1024,
            Response<Scheme, Sha256Digest> => 1024,
            Activity<Scheme, Sha256Digest> => 1024,
            ConflictingNotarize<Scheme, Sha256Digest> => 1024,
            ConflictingFinalize<Scheme, Sha256Digest> => 1024,
            NullifyFinalize<Scheme, Sha256Digest> => 1024,
        }
    }
}
