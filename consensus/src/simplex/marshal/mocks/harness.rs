...
pub trait TestHarness: 'static + Sized {
    ...
    type Variant: crate::simplex::marshal::core::Variant<
    ...
    type TestBlock: Heightable
        ...
        + Send
        + Sync
        + Into<<Self::Variant as crate::simplex::marshal::core::Variant>::Block>;
    ...
    fn propose(
        ...
        async move {
            let block: <Self::Variant as crate::simplex::marshal::core::Variant>::Block =
                block.clone().into();
            assert!(
...
pub fn commitment_fetch_height_hint_mismatch_wakes_subscriber<H: TestHarness>() {
    ...
    runner.start(|mut context| async move {
        ...
        assert_eq!(
            <<H as TestHarness>::Variant as crate::simplex::marshal::core::Variant>::commitment(
                &received
            ),
            commitment
        );
