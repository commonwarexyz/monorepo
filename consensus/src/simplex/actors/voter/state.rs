...
mod tests {
    ...
    fn setup_state(
        ...
        let state = State::new(
            ...
            Config {
                ...
                view_retention_window: ViewDelta::new(view_retention_window),
                leader_timeout: Duration::from_secs(1),
                certification_timeout: Duration::from_secs(2),
                timeout_retry: Duration::from_secs(3),
            },
        ...
        runtime.start(|mut context| async move {
            ...
            let mut state = State::new(
                ...
                Config {
                    ...
                    elector: round_robin(&verifier),
                    epoch: Epoch::new(11),
                    view_retention_window: ViewDelta::new(6),
                    leader_timeout: Duration::from_secs(1),
                    certification_timeout: Duration::from_secs(2),
                    timeout_retry: Duration::from_secs(3),
                },
    ...
    fn expire_old_round_is_noop() {
        ...
        runtime.start(|mut context| async move {
            ...
            let cfg = Config {
                ...
                elector: round_robin(&schemes[0]),
                epoch: Epoch::new(12),
                view_retention_window: ViewDelta::new(3),
                leader_timeout: Duration::from_secs(1),
                certification_timeout: Duration::from_secs(2),
                timeout_retry: Duration::from_secs(3),
            };
    ...
    fn parent_certificate_prefers_finalization() {
        ...
        runtime.start(|mut context| async move {
            ...
            let finalization = build_finalization(&verifier, &schemes, &parent_proposal);
        ...
        runtime.start(|mut context| async move {
            ...
            let mut state = State::new(
                ...
                Config {
                    ...
                    epoch,
                    view_retention_window: ViewDelta::new(20),
                    leader_timeout: Duration::from_secs(10),
        ...
        runtime.start(|mut context| async move {
            ...
            let mut state = State::new(
                ...
                Config {
                    ...
                    elector: round_robin(&verifier),
                    epoch,
                    view_retention_window: ViewDelta::new(5),
                    leader_timeout: Duration::from_secs(10),
                    certification_timeout: Duration::from_secs(10),
                    timeout_retry: Duration::from_secs(30),
                },
