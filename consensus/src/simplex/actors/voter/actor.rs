...
use commonware_cryptography::{sha256::hash, sha256::Digest as Sha256Digest, Octets, Scheme};
...
struct Round<C: Scheme, D: Octets, S: Supervisor<Index = View>> {
    supervisor: S,
...
impl<C: Scheme, D: Octets, S: Supervisor<Index = View, PublicKey = C::PublicKey>> Round<C, D, S> {
