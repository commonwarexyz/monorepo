...
mod tests {
        ...
        L: ElectorConfig<S>,
    {
        ...
        let (resolver_sender, resolver_receiver) =
            mailbox::new(context.child("mailbox"), NZUsize!(8));
        let (batcher_sender, batcher_receiver) =
            mailbox::new(context.child("mailbox"), NZUsize!(16));
        ...
        L: ElectorConfig<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            let (resolver_sender, mut resolver_receiver) =
                mailbox::new(context.child("mailbox"), NZUsize!(10));
        ...
        F: FnMut(&mut deterministic::Context, &[u8], u32) -> Fixture<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            let (resolver_sender, _resolver_receiver) = mailbox::new(context.child("mailbox"), NZUsize!(8));
            let (batcher_sender, mut batcher_receiver) = mailbox::new(context.child("mailbox"), NZUsize!(32));
            let (vote_sender, _) = oracle
                .control(me.clone())
                .register(0, TEST_QUOTA)
                .await
        ...
        L: ElectorConfig<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            // Resolver and batcher mailboxes
            let (resolver_sender, _resolver_receiver) =
                mailbox::new(context.child("mailbox"), NZUsize!(2));
            let resolver_mailbox = resolver::Mailbox::new(resolver_sender);
            let (batcher_sender, mut batcher_receiver) =
                mailbox::new(context.child("mailbox"), NZUsize!(16));
            let batcher_mailbox = batcher::Mailbox::new(batcher_sender);
        ...
        L: ElectorConfig<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            let resolver_mailbox = resolver::Mailbox::new(resolver_sender);
            let (batcher_sender, mut batcher_receiver) =
                mailbox::new(context.child("mailbox"), NZUsize!(32));
            let batcher_mailbox = batcher::Mailbox::new(batcher_sender);
        ...
        F: FnMut(&mut deterministic::Context, &[u8], u32) -> Fixture<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            let resolver_mailbox = resolver::Mailbox::new(resolver_sender);
            let (batcher_sender, mut batcher_receiver) =
                mailbox::new(context.child("mailbox"), NZUsize!(64));
            let batcher_mailbox = batcher::Mailbox::new(batcher_sender);
        ...
        L: ElectorConfig<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            let (resolver_sender, _) = mailbox::new(context.child("mailbox"), NZUsize!(8));
            let (batcher_sender, mut batcher_receiver) =
                mailbox::new(context.child("mailbox"), NZUsize!(8));
            let (vote_sender, _) = oracle
                .control(me.clone())
        ...
        F: FnMut(&mut deterministic::Context, &[u8], u32) -> Fixture<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            let (voter, mut mailbox) = Actor::new(context.child("voter"), voter_cfg);
            let (resolver_sender, _) = mailbox::new(context.child("mailbox"), NZUsize!(8));
            let (batcher_sender, mut batcher_receiver) = mailbox::new(context.child("mailbox"), NZUsize!(8));
            let (vote_sender, _) = oracle
                .control(me.clone())
                .register(0, TEST_QUOTA)
                .await
        ...
        F: FnMut(&mut deterministic::Context, &[u8], u32) -> Fixture<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            let (resolver_sender, mut resolver_receiver) = mailbox::new(context.child("mailbox"), NZUsize!(8));
            let (batcher_sender, mut batcher_receiver) = mailbox::new(context.child("mailbox"), NZUsize!(8));
            let (vote_sender, _) = oracle
                .control(me.clone())
                .register(2, TEST_QUOTA)
