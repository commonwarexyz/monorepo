...
mod tests {
    ...
    fn build_notarization<S: Scheme<Context = VoteContext<Sha256Digest>>>(
        schemes: &[S],
        namespace: &[u8],
    ...
    fn build_finalization<S: Scheme<Context = VoteContext<Sha256Digest>>>(
        schemes: &[S],
        namespace: &[u8],
        proposal: &Proposal<Sha256Digest>,
        count: usize,
    ...
    where
        S: Scheme<PublicKey = ed25519::PublicKey, Context = VoteContext<Sha256Digest>>,
