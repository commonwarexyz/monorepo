...
mod tests {
    ...
    fn test_config<S: Scheme<Sha256Digest>, B: Blocker, Re: crate::Reporter, Rl: Relay>(
        ...
        Config {
            ...
            relay,
            strategy: Sequential,
            view_retention_window: options.view_retention_window,
        ...
        F: FnMut(&mut deterministic::Context, &[u8], u32) -> Fixture<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            let batcher_cfg = test_config(
                ...
                epoch,
                BatcherOptions {
                    view_retention_window: ViewDelta::new(2),
                    floor,
                    ..Default::default()
                },
            );
            ...
            // any activity (votes within `view_retention_window` of the floor are
            // still reported)
            assert!(
