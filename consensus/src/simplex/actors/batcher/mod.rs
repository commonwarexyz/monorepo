...
mod tests {
        ...
        F: FnMut(&mut deterministic::Context, &[u8], u32) -> Fixture<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            // Initialize batcher
            let view = View::new(1);
            let abandon = batcher_mailbox.update(view, Participant::new(0), View::zero()).await;
        ...
        F: FnMut(&mut deterministic::Context, &[u8], u32) -> Fixture<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            let abandon = batcher_mailbox.update(view, leader, View::zero()).await;
            assert!(abandon.is_none());
        ...
        F: FnMut(&mut deterministic::Context, &[u8], u32) -> Fixture<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            for v in 1..skip_timeout {
                let view = View::new(v);
                let abandon = batcher_mailbox.update(view, leader, View::zero()).await;
                assert!(abandon.is_none(), "view {v} should be active (before skip_timeout)");
            }
        ...
        F: FnMut(&mut deterministic::Context, &[u8], u32) -> Fixture<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            let abandon = batcher_mailbox
                ...
                .await;
            assert!(abandon.is_none(), "leader should remain active with nullify activity");
        });
    }
        ...
        F: FnMut(&mut deterministic::Context, &[u8], u32) -> Fixture<S>,
    {
        ...
        executor.start(|mut context| async move {
            ...
            let abandon = batcher_mailbox.update(view1, leader, View::zero()).await;
            assert!(abandon.is_none());
            ...
            let abandon = batcher_mailbox.update(view3, leader, view2).await;
            assert!(abandon.is_none());
