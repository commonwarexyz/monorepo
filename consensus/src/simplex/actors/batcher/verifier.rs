...
//         add_notarize(bls12381_threshold::fixture::<MinSig, _, _>);
//         add_notarize(bls12381_threshold::fixture::<MinPk, _, _>);
//         add_notarize(bls12381_multisig::fixture::<MinSig, _, _>);
//         add_notarize(bls12381_multisig::fixture::<MinPk, _, _>);
