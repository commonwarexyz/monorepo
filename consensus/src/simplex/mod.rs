...
mod tests {
    ...
    use crate::{
        simplex::{
            ...
            scheme::{
                bls12381_multisig,
                bls12381_threshold::vrf::{self as bls12381_threshold_vrf, Seedable},
    ...
    fn test_determinism() {
        ...
        for seed in 1..6 {
            let ts_pk_state_1 = slow_and_lossy_links::<_, _, Random>(
                seed,
                bls12381_threshold_vrf::fixture::<MinPk, _>,
            );
            let ts_pk_state_2 = slow_and_lossy_links::<_, _, Random>(
                seed,
                bls12381_threshold_vrf::fixture::<MinPk, _>,
            );
