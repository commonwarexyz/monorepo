...
pub struct Config<P: FormattedArray, D: FormattedArray> {
    pub prover: Prover<D>,
...
#[derive(Clone)]
pub struct Supervisor<P: FormattedArray, D: FormattedArray> {
    prover: Prover<D>,
...
impl<P: FormattedArray, D: FormattedArray> Supervisor<P, D> {
...
impl<P: FormattedArray, D: FormattedArray> Su for Supervisor<P, D> {
    type Index = View;
    type PublicKey = P;
...
impl<P: FormattedArray, D: FormattedArray> TSu for Supervisor<P, D> {
