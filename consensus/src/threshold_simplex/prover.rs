...
impl<D: Digest> Prover<D> {
    ...
    pub fn serialize_proposal(proposal: &wire::Proposal, partial_signature: &[u8]) -> Proof {
        // Setup proof
        let len = u64::SIZE + u64::SIZE + D::SIZE + poly::PARTIAL_SIGNATURE_LENGTH;
    ...
    fn deserialize_proposal(
        ...
        let expected_len = u64::SIZE + u64::SIZE + D::SIZE + poly::PARTIAL_SIGNATURE_LENGTH;
    ...
    pub fn serialize_threshold(proposal: &wire::Proposal, signature: &[u8], seed: &[u8]) -> Proof {
        // Setup proof
        let len =
            u64::SIZE + u64::SIZE + D::SIZE + group::SIGNATURE_LENGTH + group::SIGNATURE_LENGTH;
