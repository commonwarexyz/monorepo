//! Leader election strategies for minimmit consensus.
//!
...
use crate::{
    minimmit::scheme::bls12381_threshold,
    types::{Round, View},
};
...
mod tests {
    use super::*;
    use crate::{
        minimmit::scheme::{bls12381_threshold, ed25519},
        // Use simplex's Subject type for test signing since we re-export simplex's Scheme
    ...
    fn random_uses_certificate_randomness() {
        ...
        // However, for our specific test inputs (rng seed 42, 6 participants), we've
