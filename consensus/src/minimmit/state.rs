    ...
    E: Elector<S>,
{
    ...
    views: BTreeMap<View, ViewState<S, D>>,
    ...
    E: Elector<S>,
{
    ...
    fn ensure_view(&mut self, view: View) -> &mut ViewState<S, D> {
        self.views
            .entry(view)
            .or_insert_with(|| ViewState::new(view))
    }
    ...
    fn handle_view_progress(
        ...
        if view < self.view {
            ...
            if let Some(ref proposal) = proposal {
                ...
                // Also check for contradiction - we may have voted for a different proposal
...
mod tests {
    use super::*;
    use crate::{elector::Config as ElectorConfig, minimmit::scheme::ed25519};
    ...
    fn setup_state() -> (
        State<Scheme, Sha256Digest, crate::elector::RoundRobinElector<Scheme>>,
        Vec<Scheme>,
        rand::rngs::StdRng,
    ) {
