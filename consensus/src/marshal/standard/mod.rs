...
mod tests {
    ...
    async fn setup_validator(
        ...
        validator: K,
        provider: P,
    ) -> (Application<B>, mailbox::Mailbox<S, B>, u64) {
        let config = Config {
            provider,
        ...
        (application, mailbox, last_processed_height)
    }
    ...
    fn test_subscribe_multiple_subscriptions() {
        ...
        runner.start(|mut context| async move {
            ...
            actor
                .verified(Round::new(Epoch::zero(), View::new(1)), block1.clone())
                .await;
            actor
                .verified(Round::new(Epoch::zero(), View::new(2)), block2.clone())
                .await;
    ...
    fn test_subscribe_blocks_from_different_sources() {
        ...
        runner.start(|mut context| async move {
            ...
            actor
                .verified(Round::new(Epoch::zero(), View::new(3)), block3.clone())
                .await;
            ...
            actor
                .verified(Round::new(Epoch::zero(), View::new(4)), block4.clone())
                .await;
    ...
    fn test_marshaled_rejects_invalid_ancestry() {
        ...
        runner.start(|mut context| async move {
            ...
            let honest_parent =
                B::new::<Sha256>(genesis.digest(), BLOCKS_PER_EPOCH.get() + 1, 1000);
            ...
            let malicious_block =
                B::new::<Sha256>(genesis.digest(), BLOCKS_PER_EPOCH.get() + 2, 3000);
    ...
    fn test_marshaled_rejects_unsupported_epoch() {
        ...
        runner.start(|mut context| async move {
            ...
            let parent = B::new::<Sha256>(genesis.digest(), 19, 1000);
            ...
            let block = B::new::<Sha256>(parent_digest, 20, 2000);
