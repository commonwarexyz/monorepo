...
mod test {
    use super::*;
    use crate::marshal::mocks::block::ParentBlock;
    ...
    type TestBlock = ParentBlock<Sha256Digest>;
    ...
    fn test_panics_on_non_contiguous_initial_blocks_height() {
        deterministic::Runner::default().start(|context| async move {
            stream(
                ...
                vec![
                    ParentBlock::new::<Sha256>(Sha256Digest::EMPTY, Height::new(1), 1),
                    ParentBlock::new::<Sha256>(Sha256Digest::EMPTY, Height::new(3), 3),
                ],
            );
        });
    }
    ...
    fn test_panics_on_non_contiguous_initial_blocks_digest() {
        deterministic::Runner::default().start(|context| async move {
            stream(
                ...
                vec![
                    ParentBlock::new::<Sha256>(Sha256Digest::EMPTY, Height::new(1), 1),
                    ParentBlock::new::<Sha256>(Sha256Digest::EMPTY, Height::new(2), 2),
                ],
            );
        });
    }
    ...
    fn test_panics_on_non_contiguous_fetched_parent_height() {
        deterministic::Runner::default().start(|context| async move {
            let parent = ParentBlock::new::<Sha256>(Sha256Digest::EMPTY, Height::zero(), 0);
            let child = ParentBlock::new::<Sha256>(parent.digest(), Height::new(3), 3);
    ...
    fn test_panics_on_non_contiguous_fetched_parent_digest() {
        deterministic::Runner::default().start(|context| async move {
            let expected_parent =
                ParentBlock::new::<Sha256>(Sha256Digest::EMPTY, Height::zero(), 0);
            let fetched_parent = ParentBlock::new::<Sha256>(Sha256Digest::EMPTY, Height::zero(), 1);
            let child = ParentBlock::new::<Sha256>(expected_parent.digest(), Height::new(1), 2);
    ...
    fn test_peek_available_through_ancestry_trait() {
        deterministic::Runner::default().start(|context| async move {
            ...
            let block = ParentBlock::new::<Sha256>(Sha256Digest::EMPTY, Height::new(1), 1);
    ...
    fn test_from_iter_yields_blocks_in_order_and_peeks_next() {
        deterministic::Runner::default().start(|_| async move {
            let parent = ParentBlock::new::<Sha256>(Sha256Digest::EMPTY, Height::new(1), 1);
            let child = ParentBlock::new::<Sha256>(parent.digest(), Height::new(2), 2);
    ...
    fn test_yields_genesis_and_stops() {
        deterministic::Runner::default().start(|context| async move {
            let genesis = ParentBlock::new::<Sha256>(Sha256Digest::EMPTY, Height::zero(), 0);
            let child = ParentBlock::new::<Sha256>(genesis.digest(), Height::new(1), 1);
    ...
    fn test_clone_preserves_pending_parent_fetch() {
        deterministic::Runner::default().start(|context| async move {
            let parent = Arc::new(ParentBlock::new::<Sha256>(
                Sha256Digest::EMPTY,
                Height::zero(),
                0,
            ));
            let child = ParentBlock::new::<Sha256>(parent.digest(), Height::new(1), 1);
    ...
    fn test_yields_ancestors() {
        deterministic::Runner::default().start(|context| async move {
            let block1 = ParentBlock::new::<Sha256>(Sha256Digest::EMPTY, Height::new(1), 1);
            let block2 = ParentBlock::new::<Sha256>(block1.digest(), Height::new(2), 2);
            let block3 = ParentBlock::new::<Sha256>(block2.digest(), Height::new(3), 3);
