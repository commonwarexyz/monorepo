...
mod test {
    ...
    type TestBlock = Block<Sha256Digest, u8>;
    ...
    fn test_panics_on_non_contiguous_initial_blocks_height() {
        deterministic::Runner::default().start(|context| async move {
            stream(
                ...
                vec![
                    Block::new::<Sha256>(MOCK_CONTEXT, Sha256Digest::EMPTY, Height::new(1), 1),
                    Block::new::<Sha256>(MOCK_CONTEXT, Sha256Digest::EMPTY, Height::new(3), 3),
                ],
            );
        });
    }
    ...
    fn test_panics_on_non_contiguous_initial_blocks_digest() {
        deterministic::Runner::default().start(|context| async move {
            stream(
                ...
                vec![
                    Block::new::<Sha256>(MOCK_CONTEXT, Sha256Digest::EMPTY, Height::new(1), 1),
                    Block::new::<Sha256>(MOCK_CONTEXT, Sha256Digest::EMPTY, Height::new(2), 2),
                ],
            );
        });
    }
    ...
    fn test_panics_on_non_contiguous_fetched_parent_height() {
        deterministic::Runner::default().start(|context| async move {
            let parent = Block::new::<Sha256>(MOCK_CONTEXT, Sha256Digest::EMPTY, Height::zero(), 0);
            let child = Block::new::<Sha256>(MOCK_CONTEXT, parent.digest(), Height::new(3), 3);
    ...
    fn test_panics_on_non_contiguous_fetched_parent_digest() {
        deterministic::Runner::default().start(|context| async move {
            let expected_parent =
                Block::new::<Sha256>(MOCK_CONTEXT, Sha256Digest::EMPTY, Height::zero(), 0);
            let fetched_parent =
                Block::new::<Sha256>(MOCK_CONTEXT, Sha256Digest::EMPTY, Height::zero(), 1);
            let child =
                Block::new::<Sha256>(MOCK_CONTEXT, expected_parent.digest(), Height::new(1), 2);
    ...
    fn test_peek_available_through_ancestry_trait() {
        deterministic::Runner::default().start(|context| async move {
            ...
            let block = Block::new::<Sha256>(MOCK_CONTEXT, Sha256Digest::EMPTY, Height::new(1), 1);
    ...
    fn test_from_iter_yields_blocks_in_order_and_peeks_next() {
        deterministic::Runner::default().start(|_| async move {
            let parent = Block::new::<Sha256>(MOCK_CONTEXT, Sha256Digest::EMPTY, Height::new(1), 1);
            let child = Block::new::<Sha256>(MOCK_CONTEXT, parent.digest(), Height::new(2), 2);
    ...
    fn test_yields_genesis_and_stops() {
        deterministic::Runner::default().start(|context| async move {
            let genesis =
                Block::new::<Sha256>(MOCK_CONTEXT, Sha256Digest::EMPTY, Height::zero(), 0);
            let child = Block::new::<Sha256>(MOCK_CONTEXT, genesis.digest(), Height::new(1), 1);
    ...
    fn test_clone_preserves_pending_parent_fetch() {
        deterministic::Runner::default().start(|context| async move {
            ...
            let child = Block::new::<Sha256>(MOCK_CONTEXT, parent.digest(), Height::new(1), 1);
    ...
    fn test_yields_ancestors() {
        deterministic::Runner::default().start(|context| async move {
            let block1 = Block::new::<Sha256>(MOCK_CONTEXT, Sha256Digest::EMPTY, Height::new(1), 1);
            let block2 = Block::new::<Sha256>(MOCK_CONTEXT, block1.digest(), Height::new(2), 2);
            let block3 = Block::new::<Sha256>(MOCK_CONTEXT, block2.digest(), Height::new(3), 3);
