...
fn execute_vqc_trace<V: Variant>(fixture: &Fixture<V>) {
    ...
    assert_eq!(
        fixture
            .verifier
            .verify_vqc::<Sha256, _>(&sequential, &Sequential),
        fixture
            .verifier
            .verify_vqc::<Sha256, _>(&parallel, &strategy)
    );
    assert!(
        fixture
            .verifier
...
fn inbound_larger_vqc_decodes_verifies_admits_and_uses_every_vote_for_tips() {
    ...
    assert!(
        fixture
            .verifier
            .verify_vqc::<Sha256, _>(&decoded, &Sequential)
            .is_some()
    );
...
fn execute_lqc_trace<V: Variant>(fixture: &Fixture<V>) {
    ...
    assert_eq!(
        fixture
            .verifier
            .verify_lqc::<Sha256, _>(&sequential, &Sequential),
        fixture
            .verifier
            .verify_lqc::<Sha256, _>(&parallel, &strategy)
    );
    assert!(
        fixture
            .verifier
