...
//!
//! - [`VerificationCapability`] authenticates bounded cohorts of hostile decoded artifacts and
//!   routes identities proven to have equivocated to the network blocker.
