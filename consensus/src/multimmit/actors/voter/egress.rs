...
//! telemetry only. Header retries reuse the exact encoded bytes captured when the effect was
//! installed. Relay acceptance gates the first header attempt, then refreshes at the heartbeat
//! cadence while the effect remains live.
