        ...
        for (i, (validator, _, share)) in validators.iter().enumerate() {
            ...
            let engine = Engine::new(
                ...
                Config {
                    ...
                    codex_partition: format!("aggregation/{validator}"),
                    codex_write_buffer: NZUsize!(4096),
                    codex_replay_buffer: NZUsize!(4096),
                    codex_heights_per_section: std::num::NonZeroU64::new(6).unwrap(),
                    ...
                    for (i, (validator, _, share)) in validators.iter().enumerate() {
                        ...
                        let engine = Engine::new(
                            ...
                            Config {
                                ...
                                codex_partition: format!("unclean_shutdown_test/{validator}"),
                                codex_write_buffer: NZUsize!(4096),
                                codex_replay_buffer: NZUsize!(4096),
                                codex_heights_per_section: std::num::NonZeroU64::new(6).unwrap(),
                                codex_compression: Some(3),
                ...
                for (validator, _, share) in validators.iter() {
                    ...
                    let engine = Engine::new(
                        ...
                        Config {
                            ...
                            activity_timeout: 100,
                            codex_partition: format!("unsigned_index_test/{validator}"),
                            codex_write_buffer: NZUsize!(4096),
                            codex_replay_buffer: NZUsize!(4096),
                            codex_heights_per_section: std::num::NonZeroU64::new(6).unwrap(),
                            codex_compression: Some(3),
