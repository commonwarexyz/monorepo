...
DEFAULT_INVARIANTS="no_proposal_equivocation,agreement,no_vote_equivocation_inv,no_nullification_and_finalization_in_the_same_view,validity,valid_last_finalized,notarized_consistency,unique_notarized_or_finalized_payload_per_view,finalize_vote_requires_notarization_cert,finalized_payloads_have_unique_parent,finalized_certificates_are_committed,committed_blocks_no_duplicates,certificates_require_sent_votes"
