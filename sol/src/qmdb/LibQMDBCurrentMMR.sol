...
library LibQMDBCurrentMMR {
    ...
    function verify(
        ...
        return Current.verify(root, operation, proof, false, chunkBytes, hasher);
    }
    ...
    function verifyRange(
        ...
        return Current.verifyRange(root, operations, proof, false, chunkBytes, hasher);
    }
    ...
    function verifyOpsMulti(
        ...
        return Current.verifyOpsMulti(root, operations, proof, witness, false, chunkBytes, hasher);
    }
    ...
    function verifyExclusion(
        ...
        return Current.verifyExclusion(root, key, operation, proof, false, chunkBytes, hasher);
    }
    ...
    function verifyExclusionVariable(
        ...
        return Current.verifyExclusionVariable(root, key, operation, proof, encoding, false, chunkBytes, hasher);
    }
}
